...
function failAsync(_, code) { var __frame = { name: "failAsync", line: 14 }; __func(_, this, arguments, failAsync, 0, __frame, function() {
 return _(new Error(code)); });};


function failSync(_, code) { var __frame = { name: "failSync", line: 18 }; __func(_, this, arguments, failSync, 0, __frame, function() {
 (function fail(dummy) {
...
function A(_, code) { var i; var __frame = { name: "A", line: 26 }; __func(_, this, arguments, A, 0, __frame, function() { return (function __$A(__then) {
 if ((code == 1)) {
...
function B(_, code) { var __frame = { name: "B", line: 47 }; __func(_, this, arguments, B, 0, __frame, function() { return (function __$B(__then) {
 if ((code == 7)) {
...
function C(_, code) { var __frame = { name: "C", line: 56 }; __func(_, this, arguments, C, 0, __frame, function() { return (function __$C(__then) {
 if ((code == 8)) {
 return fail(__cb(_, __frame, 2, 2, __then), code); } else { __then(); } ; })(_); });};


function D(_, code) { var __frame = { name: "D", line: 61 }; __func(_, this, arguments, D, 0, __frame, function() { return (function __$D(__then) {
 if ((code == 9)) {
 return fail(__cb(_, __frame, 2, 2, __then), code); } else { __then(); } ; })(_); });};


function E(_, code) { var __frame = { name: "E", line: 66 }; __func(_, this, arguments, E, 0, __frame, function() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$E() {
...
function T(_, fn, code, failFn) { var s, ff, end; var __frame = { name: "T", line: 79 }; __func(_, this, arguments, T, 0, __frame, function() {
 fail = failFn;
...
asyncTest("stacks", 20, function __1(_) { var __frame = { name: "__1", line: 101 }; __func(_, this, arguments, __1, 0, __frame, function() {
...
asyncTest("catch", 20, function __2(_) { var __frame = { name: "__2", line: 125 }; __func(_, this, arguments, __2, 0, __frame, function() {
