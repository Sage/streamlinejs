...
function delay(_, val) { if (!_) { return __future(delay, arguments, 0); }; var __frame = new __Frame(5, "delay"); try {
 ...
 return _(null, val); })); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };};
...
function delayFail(_, err) { if (!_) { return __future(delayFail, arguments, 0); }; var __frame = new __Frame(10, "delayFail"); try {
 ...
 return _(err); })); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };};
...
asyncTest("each", 1, function __1(_) { if (!_) { return __future(__1, arguments, 0); }; var __frame = new __Frame(17, "__1"); try { var result;
 ...
 start(); _(); }), [1,2,3,4,], function __1(_, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(19, "__1"); try { return delay(__cb(_, __frame, 1, 20, function ___(__0, __1) { result = (result * __1); _(); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("map", 1, function __2(_) { if (!_) { return __future(__2, arguments, 0); }; var __frame = new __Frame(25, "__2"); try { var result;
 ...
 start(); _(); }), [1,2,3,4,], function __1(_, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(26, "__1"); try { return delay(__cb(_, __frame, 1, 13, function ___(__0, __2) { var __1 = (2 * __2); return _(null, __1); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("filter", 1, function __3(_) { if (!_) { return __future(__3, arguments, 0); }; var __frame = new __Frame(32, "__3"); try { var result;
 ...
 start(); _(); }), [1,2,3,4,], function __1(_, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(33, "__1"); try { return delay(__cb(_, __frame, 1, 9, function ___(__0, __2) { var __1 = (__2 % 2); return _(null, __1); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("every", 1, function __4(_) { if (!_) { return __future(__4, arguments, 0); }; var __frame = new __Frame(39, "__4"); try { var result;
 ...
 start(); _(); }), [1,2,3,4,], function __1(_, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(40, "__1"); try { return delay(__cb(_, __frame, 1, 9, function ___(__0, __2) { var __1 = (__2 < 5); return _(null, __1); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("every", 1, function __5(_) { if (!_) { return __future(__5, arguments, 0); }; var __frame = new __Frame(46, "__5"); try { var result;
 ...
 start(); _(); }), [1,2,3,4,], function __1(_, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(47, "__1"); try { return delay(__cb(_, __frame, 1, 9, function ___(__0, __2) { var __1 = (__2 < 3); return _(null, __1); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("some", 1, function __6(_) { if (!_) { return __future(__6, arguments, 0); }; var __frame = new __Frame(53, "__6"); try { var result;
 ...
 strictEqual(result, true);
 start(); _(); }), [1,2,3,4,], function __1(_, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(54, "__1"); try { return delay(__cb(_, __frame, 1, 9, function ___(__0, __2) { var __1 = (__2 < 3); return _(null, __1); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("some", 1, function __7(_) { if (!_) { return __future(__7, arguments, 0); }; var __frame = new __Frame(60, "__7"); try { var result;
 ...
 strictEqual(result, false);
 start(); _(); }), [1,2,3,4,], function __1(_, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(61, "__1"); try { return delay(__cb(_, __frame, 1, 9, function ___(__0, __2) { var __1 = (__2 < 0); return _(null, __1); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("reduce", 1, function __8(_) { if (!_) { return __future(__8, arguments, 0); }; var __frame = new __Frame(67, "__8"); try { var result;
 ...
 strictEqual(result, 24);
 start(); _(); }), [1,2,3,4,], function __1(_, v, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(68, "__1"); try { return delay(__cb(_, __frame, 1, 13, function ___(__0, __2) { var __1 = (v * __2); return _(null, __1); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }, 1); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("reduceRight", 1, function __9(_) { if (!_) { return __future(__9, arguments, 0); }; var __frame = new __Frame(74, "__9"); try { var result;
 ...
 strictEqual(result, 24);
 start(); _(); }), [1,2,3,4,], function __1(_, v, val) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(75, "__1"); try { return delay(__cb(_, __frame, 1, 13, function ___(__0, __2) { var __1 = (v * __2); return _(null, __1); }), val); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }, 1); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; };});
...
asyncTest("collectAll", 1, function __10(_) { if (!_) { return __future(__10, arguments, 0); }; var __frame = new __Frame(81, "__10"); var total, peak, count, results;
 ...
 count--;
 return _(null, (2 * i)); }), i); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }; }; try { total = 0; peak = 0; count = 0;
...
asyncTest("contexts", 3, function __13(_) { if (!_) { return __future(__13, arguments, 0); }; var __frame = new __Frame(135, "__13"); var result;
 ...
 return _(null, (y + 1)); }), (2 * x)); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; }; try {
 ...
 return flows.spray([function __1(_) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = new __Frame(146, "__1"); try { return testContext(__cb(_, __frame, 1, 9, _), 3); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; },function __2(_) { if (!_) { return __future(__2, arguments, 0); } ; var __frame = new __Frame(150, "__2"); try { return testContext(__cb(_, __frame, 1, 9, _), 5); } catch (e) { __frame.err(_, e); } finally { __global.__frame = __frame.prev; }; },]).collectAll(__cb(_, __frame, 19, 14, function ___(__0, __3) { result = __3;
