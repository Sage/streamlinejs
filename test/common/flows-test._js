...
asyncTest("every true", 9, function(_) {
	...
	strictEqual(result, true);
	var result = [1, 4, 9, 16].every_(_, function(_, val, i) {
		return delay(_, i) < 4;
	});
	strictEqual(result, true);
	var result = [1, 4, 9, 16].every_(_, -1, function(_, val, i) {
		return delay(_, i) < 4;
	});
	strictEqual(result, true);
	start();
});
asyncTest("every false", 9, function(_) {
	var result = flows.every(_, [1, 2, 3, 4], function(_, val) {
	...
	strictEqual(result, false);
	result = sparse().every_(_, function(_, val) {
		return delay(_, val) > 40;
	});
	strictEqual(result, false);
	result = sparse().every_(_, -1, function(_, val) {
		return delay(_, val) > 40;
	});
	strictEqual(result, false);
	var result = [1, 4, 9, 16].every_(_, function(_, val, i) {
...
asyncTest("some true", 9, function(_) {
	...
	strictEqual(result, true);
	result = sparse().some_(_, function(_, val) {
		return delay(_, val) > 30;
	});
	strictEqual(result, true);
	result = sparse().some_(_, -1, function(_, val) {
		return delay(_, val) > 30;
	});
	strictEqual(result, true);
	var result = [1, 4, 9, 16].some_(_, function(_, val, i) {
		return delay(_, i) === 2;
	});
	strictEqual(result, true);
	var result = [1, 4, 9, 16].some_(_, -1, function(_, val, i) {
		return delay(_, i) === 2;
	});
	strictEqual(result, true);
	start();
});
asyncTest("some false", 9, function(_) {
	var result = flows.some(_, [1, 2, 3, 4], function(_, val) {
...
asyncTest("reduce", 3, function(_) {
	...
	strictEqual(result, 24);
	var result = sparse().reduce_(_, function(_, v, val, i) {
		return v + '/' + delay(_, val) + i;
	}, '');
...
asyncTest("reduceRight", 3, function(_) {
	...
	strictEqual(result, 24);
	var result = sparse().reduceRight_(_, function(_, v, val, i) {
		return v + '/' + delay(_, val) + i;
	}, '');
