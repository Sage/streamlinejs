/*** Generated by streamline 0.10.14 (generators) - DO NOT EDIT ***/var galaxy = require("streamline/lib/generators/runtime");(function(){})();(galaxy.unstar(function*(_) {var failAsync_ = galaxy.unstar(failAsync, 0), failSync_ = galaxy.unstar(failSync, 0), A_ = galaxy.unstar(A, 0), B_ = galaxy.unstar(B, 0), C_ = galaxy.unstar(C, 0), D_ = galaxy.unstar(D, 0), E_ = galaxy.unstar(E, 0), F_ = galaxy.unstar(F, 0), G_ = galaxy.unstar(G, 0), H_ = galaxy.unstar(H, 0), I_ = galaxy.unstar(I, 0), T_ = galaxy.unstar(T, 0), issue233_ = galaxy.unstar(issue233, 0); // WARNING: DO NOT INSERT COMMENTS OR ANYTHING
...
asyncTest("issue233", 1, galaxy.unstar(function*(_) {
	stackEqual((yield T(_, issue233_, 0, failSync_)), "Error: foo/customThrow:223/issue233:228");
	start();
}, 0));
