...
asyncTest("map", 9, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
	var result = (yield galaxy.invoke(flows, "map", [_, [1, 2, 3, 4], (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
		return 2 * (yield delay(_, val));
	}, 0))], 0));
	deepEqual(result, [2, 4, 6, 8]);
	var result = (yield galaxy.invoke([1, 2, 3, 4], "map_", [_, (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
		return 2 * (yield delay(_, val));
	}, 0))], 0));
	deepEqual(result, [2, 4, 6, 8]);
	var result = (yield galaxy.invoke([1, 2, 3, 4], "map_", [_, 2, (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
		return 2 * (yield delay(_, val));
	}, 0))], 0));
	deepEqual(result, [2, 4, 6, 8]);
	...
	deepEqual(result, [2, 4, 6, 8]);
	var result = (yield galaxy.invoke([1, 2, 3, 4], "map_", [_, -1, (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
		return 2 * (yield delay(_, val));
	}, 0))], 0));
	deepEqual(result, [2, 4, 6, 8]);
	result = (yield galaxy.invoke(sparse(), "map_", [_, (function(unstarred__) {  function F(_, val, i) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val, i) {
		var v = (yield delay(_, val));
		return i + ':' + v;
	}, 0))], 0));
	strictEqual(result.length, 10);
	strictEqual(dump(result), '/3:33/4:44/9:99');
	result = (yield galaxy.invoke(sparse(), "map_", [_, -1, (function(unstarred__) {  function F(_, val, i) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val, i) {
		var v = (yield delay(_, val));
		return i + ':' + v;
	}, 0))], 0));
	strictEqual(result.length, 10);
...
asyncTest("every true", 7, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
	var result = (yield galaxy.invoke(flows, "every", [_, [1, 2, 3, 4], (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
		return (yield delay(_, val)) < 5;
	}, 0))], 0));
	strictEqual(result, true);
	var result = (yield galaxy.invoke([1, 2, 3, 4], "every_", [_, (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
		return (yield delay(_, val)) < 5;
	}, 0))], 0));
	strictEqual(result, true);
	var result = (yield galaxy.invoke([1, 2, 3, 4], "every_", [_, 2, (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
		return (yield delay(_, val)) < 5;
	}, 0))], 0));
	strictEqual(result, true);
	...
	strictEqual(result, true);
	var result = (yield galaxy.invoke([1, 2, 3, 4], "every_", [_, -1, (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
		return (yield delay(_, val)) < 5;
	}, 0))], 0));
	strictEqual(result, true);
	result = (yield galaxy.invoke(sparse(), "every_", [_, (function(unstarred__) {  function F(_, val, i) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val, i) {
		return (yield delay(_, val)) > 30;
	}, 0))], 0));
	strictEqual(result, true);
	result = (yield galaxy.invoke(sparse(), "every_", [_, -1, (function(unstarred__) {  function F(_, val, i) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val, i) {
		return (yield delay(_, val)) > 30;
	}, 0))], 0));
	strictEqual(result, true);
	start();
}, 0)));
asyncTest("every false", 7, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
	var result = (yield galaxy.invoke(flows, "every", [_, [1, 2, 3, 4], (function(unstarred__) {  function F(_, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, val) {
...
asyncTest("some true", 7, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
...
asyncTest("reduce", 3, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
	var result = (yield galaxy.invoke(flows, "reduce", [_, [1, 2, 3, 4], (function(unstarred__) {  function F(_, v, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, v, val) {
		return v * (yield delay(_, val));
	}, 0)), 1], 0));
	strictEqual(result, 24);
	var result = (yield galaxy.invoke([1, 2, 3, 4], "reduce_", [_, (function(unstarred__) {  function F(_, v, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, v, val) {
		return v * (yield delay(_, val));
	}, 0)), 1], 0));
	strictEqual(result, 24);
	var result = (yield galaxy.invoke(sparse(), "reduce_", [_, (function(unstarred__) {  function F(_, v, val) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, v, val) {
		return v + '/' + (yield delay(_, val));
	}, 0)), ''], 0));
...
asyncTest("collectAll", 4, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
	var total = 0;
	var peak = 0;
	var count = 0;
...
asyncTest("collectOne", 4, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
	var total = 0;
	var peak = 0;
	var count = 0;
...
asyncTest("contexts", 3, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {var testContext_ = (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(testContext, 0));
	...
	(function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
...
asyncTest("futures multiplex", 3, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {var doIt_ = (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__1 = unstarred__.__starred__1;  F.__starred__1.__unstarred__1 = F;  return F;})(galaxy.unstar(doIt, 1));
	var result1 = 0;
	var result2 = 0;
	var result3 = 0;
