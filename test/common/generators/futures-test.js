/*** Generated by streamline 0.4.0 (generators) - DO NOT EDIT ***/var fstreamline__ = require("streamline/lib/generators/runtime"); (fstreamline__.create(function(_) {var delay_ = fstreamline__.create(delay, 2), delay2_ = fstreamline__.create(delay2, 4), join_ = fstreamline__.create(join, 8); var module = QUnit.module;
