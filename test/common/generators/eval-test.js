...
asyncTest("this in futures", 2, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
	var c = {
		v: 1,
		test: (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) { return this.v; }, 0))
	};
	strictEqual((yield galaxy.invoke(c, "test", [_], 0)), 1, "direct call");
	strictEqual((yield galaxy.invoke(null, c.test(null), [_], 0)), 1, "future call");
	start();
}, 0)));

asyncTest("arity of async functions", 3, (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_) {
	var f = (function(unstarred__) {  function F(_, a, b, c, d, e, f, g, h, i) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, a, b, c, d, e, f, g, h, i) { return a + b; }, 0));
	var g = (function(unstarred__) {  function F(_, a) {   return unstarred__.apply(this, arguments);  };  F.__starred__0 = unstarred__.__starred__0;  F.__starred__0.__unstarred__0 = F;  return F;})(galaxy.unstar(function*(_, a) { return (yield (f.__starred__0 || 0)(_, 1, 2));}, 0));
