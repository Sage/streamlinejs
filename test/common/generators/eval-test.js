/*** Generated by streamline 0.10.13 (generators) - DO NOT EDIT ***/var galaxy = require("streamline/lib/generators/runtime");(function(){})();(galaxy.unstar(function*(_) {var delay_ = galaxy.unstar(delay, 0), delayFail_ = galaxy.unstar(delayFail, 0); QUnit.module(module.id);
...
if (typeof require !== "undefined") { // skip this one in browser
	...
	// issue #218
	if (!isFast) asyncTest("coffeescript default values", 8, galaxy.unstar(function*(_) {var fn_ = galaxy.unstar(fn, {callbackIndex:2,callbackDefault:function(){ return function(e, r) {
					got = r;
				};}});
		var got;
		var that = {};
		function* fn(a, b, _, c) {
			...
			return (yield delay(_, "a=" + a + ", b=" + b + ", c=" + c));
		}
		var r = (yield galaxy.invoke(fn_, "call", [that, 3, 1, _], 3));
