/*** Generated by streamline 0.9.0 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch,__forIn=__rt.__forIn,__construct=__rt.__construct; QUnit.module(module.id);
...
asyncTest("this", 5, function __38(_) { var __frame = { name: "__38", line: 486 }; return __func(_, this, arguments, __38, 0, __frame, function __$__38() {
...
asyncTest("scoping", 1, function __39(_) { var __frame = { name: "__39", line: 537 }; return __func(_, this, arguments, __39, 0, __frame, function __$__39() {
    evalTest(function f(_) {
      function test(_) { var foo;


        function bar() {
          return foo; }; var __frame = { name: "test", line: 539 }; return __func(_, this, arguments, test, 0, __frame, function __$test() { foo = "abc";


          return delay(__cb(_, __frame, 7, 3, function __$test() {
            foo = "xyz";
            return _(null, bar); }, true)); }); }; var __frame = { name: "f", line: 538 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {


        return test(__cb(_, __frame, 13, 9, function ___(__0, __2) { var __1 = __2(); return _(null, __1); }, true)); });
    }, "xyz"); _(); });});

asyncTest("return undefined", 1, function __40(_) { var __frame = { name: "__40", line: 554 }; return __func(_, this, arguments, __40, 0, __frame, function __$__40() {
    evalTest(function f(_) {
      function test(_) { var __frame = { name: "test", line: 556 }; return __func(_, this, arguments, test, 0, __frame, function __$test() {
          return delay(__cb(_, __frame, 1, 3, function __$test() { return _(null); }, true)); }); }; var __frame = { name: "f", line: 555 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
...
asyncTest("futures test", 1, function __41(_) { var __frame = { name: "__41", line: 564 }; return __func(_, this, arguments, __41, 0, __frame, function __$__41() {
    evalTest(function f(_) { var a, b, c, d;
      function delay2(val, _) { var __frame = { name: "delay2", line: 566 }; return __func(_, this, arguments, delay2, 1, __frame, function __$delay2() {
          return delay(__cb(_, __frame, 1, 10, _, true), val); }); }; var __frame = { name: "f", line: 565 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
...
asyncTest("last case without break", 1, function __42(_) { var __frame = { name: "__42", line: 577 }; return __func(_, this, arguments, __42, 0, __frame, function __$__42() {
    evalTest(function f(_) { var __frame = { name: "f", line: 578 }; return __func(_, this, arguments, f, 0, __frame, function __$f() { return (function __$f(__break) {
          switch (true) {
...
asyncTest("async comma operator", 1, function __43(_) { var __frame = { name: "__43", line: 587 }; return __func(_, this, arguments, __43, 0, __frame, function __$__43() {
    evalTest(function f(_) { var a; var __frame = { name: "f", line: 588 }; return __func(_, this, arguments, f, 0, __frame, function __$f() { return (function __$f(_) {

          a = 4; a++; return delay(__cb(_, __frame, 2, 25, function ___(__0, __1) { a = __1; return delay(__cb(_, __frame, 2, 42, _, true), (a + 1)); }, true), (2 * a)); })(__cb(_, __frame, -587, 21, _, true)); });
    }, 11); _(); });});


asyncTest("async constructor", 1, function __44(_) { var __frame = { name: "__44", line: 594 }; return __func(_, this, arguments, __44, 0, __frame, function __$__44() {
    evalTest(function f(_) {
      function Foo(val, _) { var __this = this; var __frame = { name: "Foo", line: 596 }; return __func(_, this, arguments, Foo, 1, __frame, function __$Foo() {
          return delay(__cb(_, __frame, 1, 3, function __$Foo() {
            __this.x = val; _(); }, true)); }); }; var __frame = { name: "f", line: 595 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
...
asyncTest("fibo false async", 1, function __45(_) { var __frame = { name: "__45", line: 607 }; return __func(_, this, arguments, __45, 0, __frame, function __$__45() {
    evalTest(function f(_) {
      function fibo(_, n) { var __frame = { name: "fibo", line: 609 }; return __func(_, this, arguments, fibo, 0, __frame, function __$fibo() { return (function __$fibo(_) {
            var __1 = (n > 1); return (function __$fibo(__then) { if (__1) { return fibo(__cb(_, __frame, 1, 18, function ___(__0, __3) { return fibo(__cb(_, __frame, 1, 35, function ___(__0, __4) { var __2 = (__3 + __4); return _(null, __2); }, true), (n - 2)); }, true), (n - 1)); } else { __then(); } ; })(function __$fibo() { return _(null, 1); }); })(__cb(_, __frame, -608, 21, _, true)); }); }; var __frame = { name: "f", line: 608 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {

        return fibo(__cb(_, __frame, 4, 9, _, true), 16); });
    }, 1597); _(); });});


asyncTest("coffeescript wrapper 1", 1, function __46(_) { var __frame = { name: "__46", line: 616 }; return __func(_, this, arguments, __46, 0, __frame, function __$__46() {
    evalTest(function f(_) { var __frame = { name: "f", line: 617 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
...
asyncTest("coffeescript wrapper 2", 1, function __47(_) { var __frame = { name: "__47", line: 624 }; return __func(_, this, arguments, __47, 0, __frame, function __$__47() {
    evalTest(function f(_) { var __this = this; var __frame = { name: "f", line: 625 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
...
asyncTest("coffeescript wrapper 3", 1, function __48(_) { var __frame = { name: "__48", line: 632 }; return __func(_, this, arguments, __48, 0, __frame, function __$__48() {
    evalTest(function f(_) { var __this = this, __arguments = arguments; var __frame = { name: "f", line: 633 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
...
asyncTest("sync try/catch in async", 1, function __49(_) { var __frame = { name: "__49", line: 640 }; return __func(_, this, arguments, __49, 0, __frame, function __$__49() {
    evalTest(function f(_) { var __frame = { name: "f", line: 641 }; return __func(_, this, arguments, f, 0, __frame, function __$f() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$f() {
...
asyncTest("sync try/catch inside conditional", 1, function __50(_) { var __frame = { name: "__50", line: 650 }; return __func(_, this, arguments, __50, 0, __frame, function __$__50() {
    evalTest(function f(_) { var __frame = { name: "f", line: 651 }; return __func(_, this, arguments, f, 0, __frame, function __$f() { return (function __$f(__then) {
...
asyncTest("labelled break", 1, function __51(_) { var __frame = { name: "__51", line: 658 }; return __func(_, this, arguments, __51, 0, __frame, function __$__51() {
    evalTest(function f(_) { var result, i, j; var __frame = { name: "f", line: 659 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
        result = "";
...
asyncTest("octal literal", 1, function __52(_) { var __frame = { name: "__52", line: 679 }; return __func(_, this, arguments, __52, 0, __frame, function __$__52() {
    evalTest(function f(_) { var __frame = { name: "f", line: 680 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
        return _(null, 8); });
    }, 8); _(); });});


asyncTest("typeof rewriting bug (fibers)", 1, function __53(_) { var __frame = { name: "__53", line: 685 }; return __func(_, this, arguments, __53, 0, __frame, function __$__53() {
    evalTest(function f(_) { var hello; var __frame = { name: "f", line: 686 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
        hello = "hello";
...
asyncTest("this in futures", 2, function __59(_) { var c; var __frame = { name: "__59", line: 742 }; return __func(_, this, arguments, __59, 0, __frame, function __$__59() {
    c = {
      v: 1,
      test: function test__1(_) { var __this = this; var __frame = { name: "test__1", line: 745 }; return __func(_, this, arguments, test__1, 0, __frame, function __$test__1() { return _(null, __this.v); }); } };

    return c.test(__cb(_, __frame, 5, 13, function ___(__0, __2) { strictEqual(__2, 1, "direct call");
      return c.test(false)(__cb(_, __frame, 6, 13, function ___(__0, __3) { strictEqual(__3, 1, "future call");
        start(); _(); }, true)); }, true)); });});


asyncTest("arity of async functions", 3, function __60(_) { var f, g; var __frame = { name: "__60", line: 752 }; return __func(_, this, arguments, __60, 0, __frame, function __$__60() {
    f = function f__1(_, a, b, c, d, e, f, g, h, i) { var __frame = { name: "f__1", line: 753 }; return __func(_, this, arguments, f__1, 0, __frame, function __$f__1() { return _(null, (a + b)); }); };
    g = function g__2(_, a) { var __frame = { name: "g__2", line: 754 }; return __func(_, this, arguments, g__2, 0, __frame, function __$g__2() { return f(__cb(_, __frame, 0, 33, _, true), 1, 2); }); };
...
asyncTest("futures on _(fn, idx)", 1, function __61(_) { var f, fut; var __frame = { name: "__61", line: 761 }; return __func(_, this, arguments, __61, 0, __frame, function __$__61() {
