...
if (globals.Promise) { asyncTest("promises", (isFast ? 3 : 7), function __65(_) { var p1, p2, p3, p4;
    function test(v, _) { var __frame = { name: "test", line: 828 }; return __func(_, this, arguments, test, 1, __frame, function __$test() {
        return delay(__cb(_, __frame, 1, 9, _, true), v); }); }; var __frame = { name: "__65", line: 827 }; return __func(_, this, arguments, __65, 0, __frame, function __$__65() { return (function __$__65(__then) {
        ...
        if (!isFast) {
          ...
          return __pthen(p1, "then", __cb(_, __frame, 9, 14, function ___(__0, __1) { strictEqual(__1, "a");
            return __pthen(p2, "then", __cb(_, __frame, 10, 14, function ___(__0, __2) { strictEqual(__2, "b"); __then(); }, true)); }, true)); } else { __then(); } ; })(function __$__65() {

        p3 = test("c", null);
        strictEqual((p3 && typeof p3.then), "function");
        return __pthen(p3, "then", __cb(_, __frame, 14, 13, function ___(__0, __3) { strictEqual(__3, "c"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__65() {

                p4 = delayFail(null, "ERR d");
                return __pthen(p4, "then", __cb(_, __frame, 17, 2, function __$__65() {
...
(false && asyncTest("futures on non-streamline APIs", 1, function __66(_) { var fut;
  function nat(cb) {
    setImmediate(function() {
      cb(null, "abc"); }); }; var __frame = { name: "__66", line: 853 }; return __func(_, this, arguments, __66, 0, __frame, function __$__66() {
