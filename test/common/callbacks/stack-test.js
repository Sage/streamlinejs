...
function issue233(_, code) {
  function customThrow() {
    throw new Error("foo"); }; var __frame = { name: "issue233", line: 221 }; return __func(_, this, arguments, issue233, 0, __frame, function __$issue233() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$issue233() {
...
asyncTest("issue233", 1, function __5(_) { var __frame = { name: "__5", line: 232 }; return __func(_, this, arguments, __5, 0, __frame, function __$__5() {
    return T(__cb(_, __frame, 1, 12, function ___(__0, __1) { stackEqual(__1, "Error: foo/customThrow:223/issue233:228");
