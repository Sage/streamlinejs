/*** Generated by streamline 0.10.1a (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__g=__rt.__g,__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; QUnit.module(module.id);
...
function E(_, code) { var __frame = { name: "E", line: 66 }; return __func(_, this, arguments, E, 0, __frame, function __$E() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$E() {
          ...
          return fail(__cb(_, __frame, 2, 2, __then, true), code); }); })(function ___(ex, __result) { __g.trampoline.queue(function __$E() { if (ex) { return (function __$E(__then) {
...
function T(_, fn, code, failFn) { var s, end; var __frame = { name: "T", line: 105 }; return __func(_, this, arguments, T, 0, __frame, function __$T() {
    ...
    s = "{"; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$T() {
          ...
          return fn(__cb(_, __frame, 4, 9, _, true), code); }); })(function ___(ex, __result) { __g.trampoline.queue(function __$T() { if (ex) {
