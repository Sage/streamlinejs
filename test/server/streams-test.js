...
new streams.HttpServer(function __1(req, res, _) { if (!_) { return __future(__1, arguments, 2); }; var __frame = new __Frame(35, "__1"); try { var i;
 ...
 res.end(); _(); }); } catch (e) { __frame.err(_, e); };
...
function doTest(_, name, options, fn) { if (!_) { return __future(doTest, arguments, 0); }; var __frame = new __Frame(79, "doTest"); try { var resp, last;
 ...
 strictEqual(last, null, "read return null at end"); _(); })); }), resp); })); } catch (e) { __frame.err(_, e); };};



function dot(_) { if (!_) { return __future(dot, arguments, 0); }; var __frame = new __Frame(90, "dot"); try {
 return process.nextTick(__cb(_, __frame, 1, 1, _)); } catch (e) { __frame.err(_, e); };};
