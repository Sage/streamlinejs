/*** Generated by streamline 0.1.32 - DO NOT EDIT ***/
...
function testPass(name, options) {
 ...
 start(); _(); }), name, options, function __1(_, resp) { if (!_) { return __future(__1, arguments, 0); } ; var i, total, len, buf; i = 0; total = 0; var __3 = false; (function(__break) { var __loop = __nt(_, function() { if (__3) { i++; } else { __3 = true; } ; var __2 = (total < totalSize); if (__2) { len = ((size && (typeof size === "function")) ? size() : size); return resp.read(__cb(_, function(__0, __1) { buf = __1; total = checkBuffer(buf, total); __loop(); }), len); } else { __break(); } ; }); __loop(); })(_); }); }); };
