...
new streams.HttpServer(function __1(req, res, _) { if (!_) { return __future(__1, arguments, 2); }; var __frame = __global.__frame = { file: __srcName, name: "__1", prev: __global.__frame }; try { var i;
 ...
 return res.write(__cb(_, __frame, 41, 1, function __$__1() {
 return process.nextTick(__cb(_, __frame, 42, 1, __loop)); }), makeBuffer(i)); } else { __break(); } ; }); __loop(); })(function __$__1() {
...
function doTest(_, name, options, fn) { if (!_) { return __future(doTest, arguments, 0); }; var __frame = __global.__frame = { file: __srcName, name: "doTest", prev: __global.__frame }; try { var resp, last;

 options.url = "http://127.0.0.1:1337/";
 return streams.httpRequest(options).end().response(__cb(_, __frame, 82, 1, function ___(__0, __1) { resp = __1;
 addBufferHooks(resp.emitter);
 return fn(__cb(_, __frame, 84, 1, function __$doTest() {
 return resp.read(__cb(_, __frame, 85, 1, function ___(__0, __2) { last = __2;
...
function dot(_) { if (!_) { return __future(dot, arguments, 0); }; var __frame = __global.__frame = { file: __srcName, name: "dot", prev: __global.__frame }; try {
 return process.nextTick(__cb(_, __frame, 91, 1, _)); } catch (e) { e.__frame = (e.__frame || __frame.prev); __global.__frame = __frame; return __propagate(_, e); };};
...
function testPass(name, options) {
 ...
 asyncTest(((name + " / ") + detail), function __1(_) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = __global.__frame = { file: __srcName, name: "__1", prev: __global.__frame }; try {
 return doTest(__cb(_, __frame, 102, 1, function __$__1() {
 ...
 start(); _(); }), name, options, function __1(_, resp) { if (!_) { return __future(__1, arguments, 0); } ; var __frame = __global.__frame = { file: __srcName, name: "__1", prev: __global.__frame }; try { var i, total, len, buf; i = 0; total = 0; var __3 = false; return (function ___(__break) { var __loop = __nt(_, __frame, function __$__1() { if (__3) { i++; } else { __3 = true; } ; var __2 = (total < totalSize); if (__2) { len = ((size && (typeof size === "function")) ? size() : size); return resp.read(__cb(_, __frame, 105, 1, function ___(__0, __1) { buf = __1; total = checkBuffer(buf, total); __loop(); }), len); } else { __break(); } ; }); __loop(); })(_); } catch (e) { e.__frame = (e.__frame || __frame.prev); __global.__frame = __frame; return __propagate(_, e); }; }); } catch (e) { e.__frame = (e.__frame || __frame.prev); __global.__frame = __frame; return __propagate(_, e); }; }); };
...
asyncTest("stop  tests", 0, function __2(_) { if (!_) { return __future(__2, arguments, 0); }; var __frame = __global.__frame = { file: __srcName, name: "__2", prev: __global.__frame }; try {
 doStop = true;
