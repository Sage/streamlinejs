...
new streams.HttpServer(function __1(req, res, _) { if (!_) { return __future(__1, arguments, 2); }; var i;
 ...
 i = 0; var __2 = false; return (function ___(__break) { var __loop = __nt(_, function __$__1() { if (__2) { i++; } else { __2 = true; } ; var __1 = (i < bufCount); if (__1) {
 return res.write(__cb(_, function __$__1() {
 return process.nextTick(__cb(_, function __$__1() { __loop(); })); }), makeBuffer(i)); } else { __break(); } ; }); __loop(); })(function __$__1() {
...
function doTest(_, name, options, fn) { if (!_) { return __future(doTest, arguments, 0); }; var resp, last;
 ...
 return streams.httpRequest(options).end().response(__cb(_, function ___(__0, __1) { resp = __1;
 addBufferHooks(resp.emitter);
 return fn(__cb(_, function __$doTest() {
 return resp.read(__cb(_, function ___(__0, __2) { last = __2;
 strictEqual(last, null, "read return null at end"); _(); })); }), resp); }));};



function dot(_) { if (!_) { return __future(dot, arguments, 0); };
 return process.nextTick(__cb(_, function __$dot() { _(); }));};
...
function testPass(name, options) {
 ...
 return doTest(__cb(_, function __$__1() {
 ...
 start(); _(); }), name, options, function __1(_, resp) { if (!_) { return __future(__1, arguments, 0); } ; var i, total, len, buf; i = 0; total = 0; var __3 = false; return (function ___(__break) { var __loop = __nt(_, function __$__1() { if (__3) { i++; } else { __3 = true; } ; var __2 = (total < totalSize); if (__2) { len = ((size && (typeof size === "function")) ? size() : size); return resp.read(__cb(_, function ___(__0, __1) { buf = __1; total = checkBuffer(buf, total); __loop(); }), len); } else { __break(); } ; }); __loop(); })(function __$__1() { _(); }); }); }); };
