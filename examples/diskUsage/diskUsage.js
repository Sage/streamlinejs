...
/*    14 */       total = 0;
/*    15 */       return fs.stat(path, __cb(_, __frame, 15, 1, function ___(__0, __1) {
                    stat = __1;
                    return (function __$du(__then) {
/*    16 */           if (stat.isFile()) {
/*    17 */             return fs.readFile(path, __cb(_, __frame, 17, 1, function ___(__0, __2) {
/*    17 */               total += __2.length;
                          __then();
                        }));
                      }
...
/*    20 */                 return fs.readdir(path, __cb(_, __frame, 20, 1, function ___(__0, __3) {
                              files = __3;
/*    21 */                   i = 0;
                              var __9 = false;
...
/*    21 */                       var __8 = (i < files.length);
                                  if (__8) {
/*    22 */                         return du(__cb(_, __frame, 22, 1, function ___(__0, __4) {
/*    22 */                           total += __4;
                                      __loop();
/*    22 */                         }), ((path + "/") + files[i]));
                                  }
...
/*    34 */   t0 = Date.now();
/*    35 */   return du(__cb(_, __frame, 35, 1, function __$__$main() {
