...
/*    28 */     total = 0;
/*    29 */     return fs.stat(path, __cb(_, function ___(__0, __3) {
                  stat = __3;
                  return (function __$du(__then) {
/*    30 */         if (stat.isFile()) {
/*    31 */           return fileFunnel(__cb(_, function __$du() {
                        __then();
/*    31 */           }), function __1(_) {
                        if (!_) {
                      ...
                      ;
/*    32 */             return fs.readFile(path, __cb(_, function ___(__0, __1) {
/*    32 */               total += __1.length;
                          _();
                        }));
                      });
...
/*    37 */               return fs.readdir(path, __cb(_, function ___(__0, __4) {
                            files = __4;
/*    38 */                 futures = files.map(function(file) {
/*    39 */                   return du(null, ((path + "/") + file));
                            });
/*    41 */                 return flows.reduce(__cb(_, function ___(__0, __5) {
/*    41 */                   total += __5;
...
/*    41 */                 }), futures, function __2(_, val, future) {
                            ...
                            ;
/*    42 */                   return future(__cb(_, function ___(__0, __2) {
/*    42 */                     var __1 = (val + __2);
                                return _(null, __1);
                              }));
/*    43 */                 }, 0);
...
/*    54 */   t0 = Date.now();
/*    55 */   return du(__cb(_, function __$__$main() {
