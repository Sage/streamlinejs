...
/*    28 */       total = 0;
/*    29 */       return fs.stat(path, __cb(_, __frame, 29, 1, function ___(__0, __3) {
                    stat = __3;
                    return (function __$du(__then) {
/*    30 */           if (stat.isFile()) {
/*    31 */             return fileFunnel(__cb(_, __frame, 31, 1, __then), function __1(_) {
                          if (!_) {
                        ...
                        ;
                          ...
                          try {
/*    32 */                 return fs.readFile(path, __cb(_, __frame, 32, 1, function ___(__0, __1) {
/*    32 */                   total += __1.length;
                              _();
                            }));
                          } catch (e) {
...
/*    37 */                 return fs.readdir(path, __cb(_, __frame, 37, 1, function ___(__0, __4) {
                              files = __4;
/*    38 */                   futures = files.map(function(file) {
/*    39 */                     return du(null, ((path + "/") + file));
                              });
/*    41 */                   return flows.reduce(__cb(_, __frame, 41, 1, function ___(__0, __5) {
/*    41 */                     total += __5;
...
/*    41 */                   }), futures, function __2(_, val, future) {
                              ...
                              ;
                                ...
                                try {
/*    42 */                       return future(__cb(_, __frame, 42, 1, function ___(__0, __2) {
/*    42 */                         var __1 = (val + __2);
                                    return _(null, __1);
                                  }));
                                } catch (e) {
...
/*    54 */   t0 = Date.now();
/*    55 */   return du(__cb(_, __frame, 55, 1, function __$__$main() {
