...
var __global = typeof global !== 'undefined' ? global : window;var __srcName='./examples/streams/googleClient_.js';
...
/*    25 */       return req.end().response(__cb(_, __frame, 25, 1, function ___(__0, __1) {
                    resp = __1;
/*    27 */         return resp.checkStatus(200).readAll(__cb(_, __frame, 27, 1, function ___(__0, __3) {
...
/*    34 */   return google(str, __cb(_, __frame, 34, 1, function ___(__0, __1) {
                result = __1;
