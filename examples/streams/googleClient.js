...
/*    25 */     return req.end().response(__cb(_, function ___(__0, __1) {
                  resp = __1;
/*    27 */       return resp.checkStatus(200).readAll(__cb(_, function ___(__0, __3) {
...
/*    34 */   return google(str, __cb(_, function ___(__0, __1) {
                result = __1;
