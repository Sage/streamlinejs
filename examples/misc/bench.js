...
var __rt=require('streamline-runtime')(__filename),__func=__rt.__func,__cb=__rt.__cb,__forIn=__rt.__forIn,__tryCatch=__rt.__tryCatch,__trap=__rt.__trap,__propagate=__rt.__propagate,__future=__rt.__future,__setEF=__rt.__setEF,__g=__rt.__g;
            (function main(_) {
              var mode, benches;
