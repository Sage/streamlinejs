...
declare module "fs" {
    ...
    export function stat(path: string, callback: (err: Error, stats: Stats) =>any): void; // BRJOU 
    ...
    export function readFile(filename: string, encoding: string, callback: (err: Error, data: string) => void ): void; // BRJOU
