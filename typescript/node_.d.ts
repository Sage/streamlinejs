...
declare module "http" {
    ...
    export interface Server extends events.NodeEventEmitter {
        listen(port: number, hostname?: string, backlog?: number, callback?: async) : any;
        listen(path: string, callback?: async) : any;
    ...
    export interface ClientRequest extends events.NodeEventEmitter, stream.WritableStream {
        ...
        abort(): void;
        setTimeout(timeout: number, callback?: async) : any;
...
declare module "cluster" {
    ...
    export function disconnect(callback?: async) : any;
...
declare module "readline" {
    ...
    export interface ReadLine extends events.NodeEventEmitter {
        ...
        question(query: string, callback: async) : any;
        pause(): void;
        resume(): void;
        close(): void;
...
declare module "net" {
    ...
    export interface NodeSocket extends stream.ReadWriteStream {
        ...
        bufferSize: number;
        setEncoding(encoding?: string): void;
        write(data: any, encoding?: string, callback?: async) : any;
        end(data?: any, encoding?: string): void;
        destroy(): void;
        pause(): void;
        resume(): void;
...
declare module "dgram" {
    ...
    interface Socket extends events.NodeEventEmitter {
        send(buf: NodeBuffer, offset: number, length: number, port: number, address: string, callback?: async) : any;
...
declare module "fs" {
    ...
    export function rename(oldPath: string, newPath: string, callback?: async) : any;
    export function renameSync(oldPath: string, newPath: string): void;
    export function truncate(fd: string, len: number, callback?: async) : any;
    export function truncateSync(fd: string, len: number): void;
    export function chown(path: string, uid: number, gid: number, callback?: async) : any;
    export function chownSync(path: string, uid: number, gid: number): void;
    export function fchown(fd: string, uid: number, gid: number, callback?: async) : any;
    export function fchownSync(fd: string, uid: number, gid: number): void;
    export function lchown(path: string, uid: number, gid: number, callback?: async) : any;
    export function lchownSync(path: string, uid: number, gid: number): void;
    export function chmod(path: string, mode: string, callback?: async) : any;
    export function chmodSync(path: string, mode: string): void;
    export function fchmod(fd: string, mode: string, callback?: async) : any;
    ...
    export function stat(path: string, callback?: async) : Stats;
    ...
    export function link(srcpath: string, dstpath: string, callback?: async) : any;
    ...
    export function rmdir(path: string, callback?: async) : any;
    export function rmdirSync(path: string): void;
    export function mkdir(path: string, mode?: string, callback?: async) : any;
    export function mkdirSync(path: string, mode?: string): void;
    export function readdir(path: string, callback?: async) : string[];
    ...
    export function futimes(fd: string, atime: number, mtime: number, callback?: async) : any;
    export function futimesSync(fd: string, atime: number, mtime: number): void;
    export function fsync(fd: string, callback?: async) : any;
    ...
    export function appendFile(filename: string, data: any, encoding?: string, callback?: async) : any;
...
declare module "tls" {
    ...
    export interface Server extends net.Server {
        ...
        listen(port: number, host?: string, callback?: async) : any;
        close(): void;
        address(): { port: number; family: string; address: string; };
...
declare module "crypto" {
    ...
    export function randomBytes(size: number, callback?: async) : NodeBuffer;
}
