/*** Generated by streamline 0.10.1a (generators-fast) - DO NOT EDIT ***/var galaxy = require("streamline/lib/generators-fast/runtime"); galaxy.unstar((function*(_) { /**
		...
		value: function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				result = this.map(function(elt, i) {
					return galaxy.spin(fun(false, function*(_) {
