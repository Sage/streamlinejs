/*** Generated by streamline --lines-preserve 0.1.11 - DO NOT EDIT ***/
 ...
 exports.each = function __3(_, array, fn, thisObj) { if (!_) { return __future(__3, arguments, 0); } ; var __ = _;
 ...
 exports.map = function __4(_, array, fn, thisObj) { if (!_) { return __future(__4, arguments, 0); } ; var __ = _;
 if (!array) {
 return _(null, array) };
 var result = [];
 var len = array.length;
 ...
 exports.filter = function __5(_, array, fn, thisObj) { if (!_) { return __future(__5, arguments, 0); } ; var __ = _;
 if (!array) {
 return _(null, array) };
 var result = [];
 var len = array.length;
 ...
 exports.every = function __6(_, array, fn, thisObj) { if (!_) { return __future(__6, arguments, 0); } ; var __ = _;
 ...
 exports.some = function __7(_, array, fn, thisObj) { if (!_) { return __future(__7, arguments, 0); } ; var __ = _;
 if (!array) { return _(null) };
 ...
 exports.reduce = function __8(_, array, fn, v, thisObj) { if (!_) { return __future(__8, arguments, 0); } ; var __ = _;
 if (!array) {
 return _(null, v) };
 var len = array.length;
 var i = 0; var __2 = false; return function(__break) { var __loop = __nt(_, function() { var __ = __loop; if (__2) { i++; } else { __2 = true; } ; if ((i < len)) {
 ...
 exports.reduceRight = function __9(_, array, fn, v, thisObj) { if (!_) { return __future(__9, arguments, 0); } ; var __ = _;
 if (!array) {
 return _(null, v) };
 var len = array.length;
 ...
 exports.eachKey = function __10(_, obj, fn, thisObj) { if (!_) { return __future(__10, arguments, 0); } ; var __ = _;
 if (!obj) {
 return _(null, obj) };
 ...
 (function __1(i) {
 funnel.channel(function __1(err, result) {
 if (err) {
 return callback(err) };
 if (trim) {
 ...
 this.channel = function __1(callback, fn) {
