/*** Generated by streamline --lines-preserve 0.1.11 - DO NOT EDIT ***/
 ...
 exports.each = function(_, array, fn, thisObj) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 ...
 exports.map = function(_, array, fn, thisObj) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 if (!array) {
 return _(null, array) };
 var result = [];
 var len = array.length;
 ...
 exports.filter = function(_, array, fn, thisObj) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 if (!array) {
 return _(null, array) };
 var result = [];
 var len = array.length;
 ...
 exports.every = function(_, array, fn, thisObj) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 ...
 exports.some = function(_, array, fn, thisObj) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 if (!array) { return _(null) };
 ...
 exports.reduce = function(_, array, fn, v, thisObj) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 if (!array) {
 return _(null, v) };
 var len = array.length;
 var i = 0; var __2 = false; return function(__break) { var __loop = __nt(_, function() { var __ = __loop; if (__2) { i++; } else { __2 = true; } ; if ((i < len)) {
 ...
 exports.reduceRight = function(_, array, fn, v, thisObj) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 if (!array) {
 return _(null, v) };
 var len = array.length;
 ...
 exports.eachKey = function(_, obj, fn, thisObj) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 if (!obj) {
 return _(null, obj) };
