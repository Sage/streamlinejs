/*** Generated by streamline 0.8.1 (fibers-fast) - DO NOT EDIT ***/var fstreamline__ = require("streamline/lib/fibers-fast/runtime"); fstreamline__.create((function(_) { /**
	...
	exports.funnel = function(max) {
		...
		var funCb = function(callback, fn) {
				...
				function _doOne() {
					...
					active++;
					fstreamline__.create(current.fn,0)(function(err, result) {
						active--;
						if (!closed) {
		...
		value: function(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				result = this.map(function(elt, i) {
					return fstreamline__.spin(null, fun, [null, function(_) {
