/*** Generated by streamline 0.7.0a (fibers-fast) - DO NOT EDIT ***/var fstreamline__ = require("streamline/lib/fibers-fast/runtime"); fstreamline__.create((function(_) { /**
		...
		value: function(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				result = this.map(function(elt, i) {
					return fstreamline__.spin(fun, this, [null, function(_) {
