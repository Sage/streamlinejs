...
(function(exports) {
	...
	exports.runtime = function(filename, implicitFutures) {
		__g.implicitFutures = implicitFutures;
		function __func(_, __this, __arguments, fn, index, frame, body) {
			if (typeof _ !== 'function') {
				if (_ !== false && !__g.implicitFutures) throw new Error("invalid argument #" + index + ": you must pass _ or !_ (https://github.com/Sage/streamlinejs/issues/164)");
