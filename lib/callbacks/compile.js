/*** Generated by streamline 0.10.1b (callbacks) - DO NOT EDIT ***/ "use strict"; var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; var fs = require("fs");
          ...
          banner = ((shebang + le) + banner); return (function __$exports_compileFile__1(_) {
            ...
            if (options.sourceMap) {
              ...
              sourceMap = sourceMap.map; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {
                  ...
                  return fs.writeFile(dstName, transformed, "utf8", __cb(_, __frame, 63, 2, __then, true)); }); })(function ___(ex, __result) { __catch(function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$exports_compileFile__1() { return (function __$exports_compileFile__1(__then) {
                  ...
                  if (options.sourceMap) {
                    if (options.prevMap) {
                      sourceMap.applySourceMap(options.prevMap, options.sourceName); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {
                          ...
                          return fs.writeFile(mapFile, sourceMap.toString(), "utf8", __cb(_, __frame, 72, 3, __then, true)); }); })(function ___(ex, __result) { __catch(function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(_); }); }); }, true)); }, true)); }, true), dstName); }, true), path); });};
