...
exports.compileFile = function exports_compileFile__1(_, path, options) { var ext, language, basename, dirname, dstName, mtimeSrc, mtimeDst, transform, banner, content, shebangparse, shebang, le, coffee, transformed, sourceMap, mapFile; var __frame = { name: "exports_compileFile__1", line: 75 }; return __func(_, this, arguments, exports_compileFile__1, 0, __frame, function __$exports_compileFile__1() {
    ...
    return mtime(__cb(_, __frame, 7, 16, function ___(__0, __2) { mtimeSrc = __2;
      return mtime(__cb(_, __frame, 8, 16, function ___(__0, __3) { mtimeDst = __3;
        ...
        return fs.readFile(path, "utf8", __cb(_, __frame, 13, 18, function ___(__0, __4) { content = __4;
          ...
          banner = ((shebang + le) + banner); return (function __$exports_compileFile__1(_) {
            var __1 = mtimeDst; if (!__1) { return _(null, __1); } ; return fs.readFile(dstName, "utf8", __cb(_, __frame, 41, 34, _, true)); })(__cb(_, __frame, -74, 6, function ___(__0, __5) { transformed = __5;
            ...
            if ((typeof transformed == "string")) {
              ...
              if (options.sourceMap) {
                ...
                sourceMap = sourceMap.map; } ; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {
                  ...
                  return fs.writeFile(dstName, transformed, "utf8", __cb(_, __frame, 68, 5, __then, true)); }); })(function ___(ex, __result) { __catch(function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$exports_compileFile__1() { return (function __$exports_compileFile__1(__then) {
                  ...
                  if (options.sourceMap) {
                    if (options.prevMap) {
                      sourceMap.applySourceMap(options.prevMap, options.sourceName); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {
                          ...
                          return fs.writeFile(mapFile, sourceMap.toString(), "utf8", __cb(_, __frame, 77, 6, __then, true)); }); })(function ___(ex, __result) { __catch(function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(_); }); }); }, true)); }, true)); }, true), dstName); }, true), path); });};
...
exports.compile = function exports_compile__3(_, paths, options) { var failed, transform, cwd;
  function _compile(_, path, options) { var stat, ext, jsPath, source, coffee, compiled; var __frame = { name: "_compile", line: 265 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
      return fs.stat(path, __cb(_, __frame, 1, 16, function ___(__0, __3) { stat = __3; return (function __$_compile(__then) {
          if (stat.isDirectory()) {
            return fs.readdir(path, __cb(_, __frame, 3, 6, function ___(__0, __4) { return __4.forEach_(__cb(_, __frame, 3, 24, __then, true), function __1(_, f) { var __frame = { name: "__1", line: 268 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
    ...
    return paths.forEach_(__cb(_, __frame, 41, 7, function __$exports_compile__3() {
      ...
      if (failed) { return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }, true), function __1(_, path) { var __frame = { name: "__1", line: 305 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, function __$__1() { _(); }, true), fspath.resolve(cwd, path), options); }); }); });};