/*** Generated by streamline 0.9.0 (callbacks) - DO NOT EDIT ***/ "use strict"; var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; var fs = require("fs");
          ...
          banner = ((shebang + le) + banner); return (function __$exports_compileFile__1(_) {
            ...
            if (options.sourceMap) {
              ...
              sourceMap = sourceMap.map; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {
                  ...
                  return fs.writeFile(dstName, transformed, "utf8", __cb(_, __frame, 63, 2, __then, true)); }); })(function ___(ex, __result) { __tryCatch(_, function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$exports_compileFile__1() { return (function __$exports_compileFile__1(__then) {
                  ...
                  if (options.sourceMap) {
                    if (options.prevMap) {
                      sourceMap.applySourceMap(options.prevMap, options.sourceName); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {
                          ...
                          return fs.writeFile(options.sourceMap, sourceMap.toString(), "utf8", __cb(_, __frame, 70, 3, __then, true)); }); })(function ___(ex, __result) { __tryCatch(_, function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(_); }); }); }, true)); }, true)); }, true), dstName); }, true), path); });};
...
exports.loadFile = function exports_loadFile__2(_, path, options) { var ext, basename, dirname, js, transform, banner, content, shebangparse, shebang, le, matches; var __frame = { name: "exports_loadFile__2", line: 155 }; return __func(_, this, arguments, exports_loadFile__2, 0, __frame, function __$exports_loadFile__2() {
    options = _extend({ }, (options || { }));
...
function mkdirs(_, path) { var p, i, segs, seg; var __frame = { name: "mkdirs", line: 199 }; return __func(_, this, arguments, mkdirs, 0, __frame, function __$mkdirs() {
    p = "";
    i = 0;
...
function cachedTransform(_, content, path, transform, banner, options) { var i, dir, f, transformed; var __frame = { name: "cachedTransform", line: 224 }; return __func(_, this, arguments, cachedTransform, 0, __frame, function __$cachedTransform() {
...
exports.compile = function exports_compile__3(_, paths, options) { var failed, transform, cwd;
  function _compile(_, path, options) { var stat, ext, jsPath, source, coffee, compiled; var __frame = { name: "_compile", line: 258 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
      return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __3) { stat = __3; return (function __$_compile(__then) {
          if (stat.isDirectory()) {
            return fs.readdir(path, __cb(_, __frame, 3, 3, function ___(__0, __4) { return __4.forEach_(__cb(_, __frame, 3, 3, __then, true), function __1(_, f) { var __frame = { name: "__1", line: 261 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
              ...
              if (stat.isFile()) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$_compile() {
                      ...
                      return exports.loadFile(__cb(_, __frame, 8, 4, function __$_compile() {
                            ...
                            return exports.compileFile(__cb(_, __frame, 11, 5, __then, true), path, options); } else { return (function __$_compile(__then) {
                              if (((ext === ".coffee") && (path[((path.length - ext.length) - 1)] !== "_"))) {
                                jsPath = (path.substring(0, (path.length - ext.length)) + ".js"); return (function __$_compile(_) {
                                  var __2 = options.force; if (__2) { return _(null, __2); } ; return mtime(__cb(_, __frame, 14, 26, function ___(__0, __4) { return mtime(__cb(_, __frame, 14, 43, function ___(__0, __5) { var __3 = (__4 > __5); return _(null, __3); }, true), jsPath); }, true), path); })(__cb(_, __frame, -257, 6, function ___(__0, __5) { return (function __$_compile(__then) { if (__5) {
                        ...
                        failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); }, true)); }); }; var __frame = { name: "exports_compile__3", line: 257 }; return __func(_, this, arguments, exports_compile__3, 0, __frame, function __$exports_compile__3() {
    ...
    return paths.forEach_(__cb(_, __frame, 41, 1, function __$exports_compile__3() {
      ...
      if (failed) { return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }, true), function __1(_, path) { var __frame = { name: "__1", line: 298 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _, true), fspath.resolve(cwd, path), options); }); }); });};
