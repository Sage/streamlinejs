/*** Generated by streamline 0.2.5 - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__propagate=__rt.__propagate,__trap=__rt.__trap,__future=__rt.__future,__setEF=__rt.__setEF,__g=__rt.__g; (function(exports) {
 ...
 Array.prototype.forEach_ = function Array_prototype_forEach___1(_, options, fn, thisObj) { var par, len, i, __this = this; var __frame = { name: "Array_prototype_forEach___1", line: 107 }; return __func(_, this, arguments, Array_prototype_forEach___1, 0, __frame, function __$Array_prototype_forEach___1() {
 ...
 Array.prototype.map_ = function Array_prototype_map___2(_, options, fn, thisObj) { var par, len, result, i, fun, __this = this; var __frame = { name: "Array_prototype_map___2", line: 123 }; return __func(_, this, arguments, Array_prototype_map___2, 0, __frame, function __$Array_prototype_map___2() {
 if ((typeof options === "function")) { thisObj = fn, fn = options, options = 1; } ;
 par = _parallel(options);
 thisObj = ((thisObj !== undefined) ? thisObj : __this);
 ...
 return fun(null, function __1(_) { var __frame = { name: "__1", line: 136 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 Array.prototype.filter_ = function Array_prototype_filter___3(_, options, fn, thisObj) { var par, result, len, i, elt, __this = this; var __frame = { name: "Array_prototype_filter___3", line: 146 }; return __func(_, this, arguments, Array_prototype_filter___3, 0, __frame, function __$Array_prototype_filter___3() {
 if ((typeof options === "function")) { thisObj = fn, fn = options, options = 1; } ;
 par = _parallel(options);
 thisObj = ((thisObj !== undefined) ? thisObj : __this);
 result = [];
 ...
 return __this.map_(__cb(_, __frame, 12, 3, __then, true), par, function __1(_, elt) { var __frame = { name: "__1", line: 158 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 Array.prototype.every_ = function Array_prototype_every___4(_, options, fn, thisObj) { var par, len, i, fun, futures, __this = this; var __frame = { name: "Array_prototype_every___4", line: 166 }; return __func(_, this, arguments, Array_prototype_every___4, 0, __frame, function __$Array_prototype_every___4() {
 if ((typeof options === "function")) { thisObj = fn, fn = options, options = 1; } ;
 par = _parallel(options);
 thisObj = ((thisObj !== undefined) ? thisObj : __this);
 ...
 return fun(null, function __1(_) { var __frame = { name: "__1", line: 178 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 Array.prototype.some_ = function Array_prototype_some___5(_, options, fn, thisObj) { var par, len, i, fun, futures, __this = this; var __frame = { name: "Array_prototype_some___5", line: 193 }; return __func(_, this, arguments, Array_prototype_some___5, 0, __frame, function __$Array_prototype_some___5() {
 if ((typeof options === "function")) { thisObj = fn, fn = options, options = 1; } ;
 par = _parallel(options);
 thisObj = ((thisObj !== undefined) ? thisObj : __this);
 ...
 fun = funnel(par);
 futures = __this.map(function(elt) {
 return fun(null, function __1(_) { var __frame = { name: "__1", line: 205 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 return fn.call(thisObj, __cb(_, __frame, 1, 12, _, true), elt); }); }); });
 ...
 Array.prototype.reduce_ = function Array_prototype_reduce___6(_, fn, v, thisObj) { var len, i, __this = this; var __frame = { name: "Array_prototype_reduce___6", line: 220 }; return __func(_, this, arguments, Array_prototype_reduce___6, 0, __frame, function __$Array_prototype_reduce___6() {
 thisObj = ((thisObj !== undefined) ? thisObj : __this);
 len = __this.length;
 ...
 Array.prototype.reduceRight_ = function Array_prototype_reduceRight___7(_, fn, v, thisObj) { var len, i, __this = this; var __frame = { name: "Array_prototype_reduceRight___7", line: 230 }; return __func(_, this, arguments, Array_prototype_reduceRight___7, 0, __frame, function __$Array_prototype_reduceRight___7() {
 thisObj = ((thisObj !== undefined) ? thisObj : __this);
 len = __this.length;
 ...
 function _qsort(_, beg, end) { var tmp, mid, o, nbeg, nend; var __frame = { name: "_qsort", line: 247 }; return __func(_, this, arguments, _qsort, 0, __frame, function __$_qsort() {
 ...
 if ((beg < nend)) { return _qsort(__cb(_, __frame, 31, 19, __then, true), beg, nend); } else { __then(); } ; })(_); }); }); }); }); }; var __frame = { name: "Array_prototype_sort___8", line: 242 }; return __func(_, this, arguments, Array_prototype_sort___8, 0, __frame, function __$Array_prototype_sort___8() { array = __this; beg = (beg || 0); end = ((end == null) ? (array.length - 1) : end);
