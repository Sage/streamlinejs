...
function _compile(_, input, output, options) { var __ = (_ = (_ || __trap));
 ...
 if (stat.isDirectory()) {
 output = (output || input);
 return fs.readdir(input, __cb(_, function(__0, __3) { return flows.each(__cb(_, __), __3, function(_, f) { var __ = (_ = (_ || __trap));
...
exports.compile = function(options, _) { var __ = (_ = (_ || __trap));
 ...
 var cwd = process.cwd;
 return flows.each(__cb(_, __), options.inputs, function(_, input) { var __ = (_ = (_ || __trap));
