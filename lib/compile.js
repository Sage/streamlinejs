...
function _compile(_, input, output, options) { if (!_) { return __future(_compile, arguments, 0); }; var __ = _;
 ...
 if (stat.isDirectory()) {
 output = (output || input);
 return fs.readdir(input, __cb(_, function(__0, __3) { return flows.each(__cb(_, __), __3, function(_, f) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 ...
 var banner = transform.banner(options); return function(__) { return function(_) { if (!_) { return __future(null, arguments, 0); } ; var __ = _; return function(_) { if (!_) { return __future(null, arguments, 0); } ; var __ = _; return function(_) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
 ...
 return fs.readFile(output, "utf8", __cb(_, function(__0, __2) { return _(null, (__2.substring(0, banner.length) == banner)); })); })); }(__cb(_, function(__0, __1) { if (__1) { return _(null); } ; return __(); })); }(function() {
...
exports.compile = function(options, _) { if (!_) { return __future(null, arguments, 1); }; var __ = _;
 options = (options || { });
 if (options.verbose) {
 ...
 var cwd = process.cwd;
 return flows.each(__cb(_, __), options.inputs, function(_, input) { if (!_) { return __future(null, arguments, 0); } ; var __ = _;
