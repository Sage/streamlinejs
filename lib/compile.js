/*** Generated by streamline.js 0.1.3b - 1299011772000 - DO NOT EDIT ***/
        ...
        if (stat.isDirectory()) {
            ...
            return fs.readdir(input, __cb(_, this, function(__0, __3) {
                return flows.each(__cb(_, this, __), __3, function(_, f) {
                    var __ = (_ = (_ || __throw));
                    return _compile(__cb(_, this, __), path.join(input, f), path.join(output, f), options);
                });
            }));
        }
         else {
            if ((stat.isFile() && input.match(/_\.js$/))) {
                ...
                return fs.readFile(input, "utf8", __cb(_, this, function(__0, source) {
                    ...
                    return (function(__) {
                        ...
                        return (function(__) {
                            return _exists(output, __cb(_, this, function(__0, __7) {
                                if (__7) {
                                    return (function(_) {
                                        var __ = (_ = (_ || __throw));
                                        var __val = !options.force;
                                        if ((!__val == true)) {
                                            return _(null, __val);
                                        }
                                    ;
                                        return fs.readFile(output, "utf8", __cb(_, this, function(__0, __1) {
                                            return _(null, (__1.substring(0, banner.length) === banner));
                                        }));
