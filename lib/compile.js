...
function _compile(_, input, output, options) { var __ = (_ = (_ || __throw));
 ...
 return fs.readFile(output, "utf8", __cb(_, this, function(__0, __2) { return _(null, (__2.substring(0, banner.length) == banner)); })); })); }).call(this, __cb(_, this, function(__0, __1) { if (__1) { return _(null, null); } ; return __(); })); }).call(this, function() {
