/*** Generated by streamline 0.1.27new1 - DO NOT EDIT ***/
...
;
  ...
  ;
    ...
    ;
      ...
      return fs.stat(path, __cb(_, function(__0, __3) {
        stat = __3;
          ...
          if (stat.isFile()) {
            ...
            return (function(__then) {
              if (stat.isDirectory()) {
                ...
                doc = "";
                return fs.readdir(path, __cb(_, function(__0, __5) {
                  files = __5;
                  i = 0;
                  var __11 = false;
                  (function(__break) {
