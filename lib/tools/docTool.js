/*** Generated by streamline 0.1.46 - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__trap=__rt.__trap,__propagate=__rt.__propagate,__future=__rt.__future,__setEF=__rt.__setEF,__g=__rt.__g; (function main(_) { var fs, fsp; var __frame = { name: "main", line: 1 }; return __func(_, this, arguments, main, 0, __frame, function __$main() {
 ...
 function _generate(_, path, dontSave) { var stat, inside, doc, split, isPackage, files, i; var __frame = { name: "_generate", line: 33 }; return __func(_, this, arguments, _generate, 0, __frame, function __$_generate() {
 ...
 return _generate(__cb(_, __frame, 26, 11, function ___(__0, __4) { doc += __4; while (__more) { __loop(); }; __more = true; }), ((path + "/") + files[i]), (isPackage || dontSave)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$_generate() { return (function __$_generate(__then) {
