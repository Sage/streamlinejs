...
var __global = typeof global !== 'undefined' ? global : window;var __srcName='node_modules/streamline/lib/tools/docTool_.js';
...
(function __$main(_) {
  ...
  exports.generate = function exports_generate__1(_, path, options) {
    function _generate(_, path) {
      ...
      return __func(_, this, arguments, _generate, 0, __frame, function __$_generate() {
    ...
    var __frame = {
      name: "exports_generate__1",
      line: 31
    };
    return __func(_, this, arguments, exports_generate__1, 0, __frame, function __$exports_generate__1() {
      options = (options || {
      });
