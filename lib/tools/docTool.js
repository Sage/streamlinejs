  ...
  ;
    ...
    ;
      ...
      try {
        ...
        return fs.stat(path, __cb(_, __frame, 1, 1, function ___(__0, __1) {
          stat = __1;
          return (function __$_generate(__then) {
            if (stat.isFile()) {
              return (function __$_generate(__then) {
                if ((path.indexOf(".js") == (path.length - 3))) {
                  return fs.readFile(path, "utf8", __cb(_, __frame, 5, 1, function ___(__0, __2) {
                    doc = __2.split("\n").map(function(line) {
                      var i = line.indexOf(("//" + "/ "));
              ...
              return (function __$_generate(__then) {
                if (stat.isDirectory()) {
                  ...
                  doc = "";
                  return fs.readdir(path, __cb(_, __frame, 24, 1, function ___(__0, __3) {
                    files = __3;
                    i = 0;
                    var __9 = false;
                    return (function ___(__break) {
                      ...
                      ;
                        ...
                        if (__8) {
                          return _generate(__cb(_, __frame, 26, 1, function ___(__0, __4) {
                            doc += __4;
                            __loop();
                          }), ((path + "/") + files[i]));
                        }
                      ...
                      return (function __$_generate(__then) {
                        if ((isPackage && doc)) {
                          return fs.writeFile((path + "/API.md"), doc, "utf8", __cb(_, __frame, 29, 1, function __$_generate() {
                            if (options.verbose) {
