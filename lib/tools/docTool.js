...
var __global = typeof global !== 'undefined' ? global : window;var __srcName='./lib/tools/docTool_.js';
...
(function __$main(_) {
    ...
    try {
      ...
      ;
        ...
        try {
          ...
          return fs.stat(path, __cb(_, __frame, 34, 1, function ___(__0, __1) {
            stat = __1;
            return (function __$_generate(__then) {
              if (stat.isFile()) {
                return (function __$_generate(__then) {
                  if ((path.indexOf(".js") == (path.length - 3))) {
                    return fs.readFile(path, "utf8", __cb(_, __frame, 38, 1, function ___(__0, __2) {
                      doc = __2.split("\n").map(function(line) {
                        var i = line.indexOf(("//" + "/ "));
                ...
                return (function __$_generate(__then) {
                  if (stat.isDirectory()) {
                    ...
                    doc = "";
                    return fs.readdir(path, __cb(_, __frame, 57, 1, function ___(__0, __3) {
                      files = __3;
                      i = 0;
                      var __9 = false;
                      return (function ___(__break) {
                        ...
                        ;
                          ...
                          if (__8) {
                            return _generate(__cb(_, __frame, 59, 1, function ___(__0, __4) {
                              doc += __4;
                              __loop();
                            }), ((path + "/") + files[i]));
                          }
                        ...
                        return (function __$_generate(__then) {
                          if ((isPackage && doc)) {
                            return fs.writeFile((path + "/API.md"), doc, "utf8", __cb(_, __frame, 62, 1, function __$_generate() {
                              if (options.verbose) {
      ...
      return _generate(__cb(_, __frame, 71, 1, _), path);
    } catch (e) {
      e.__frame = (e.__frame || __frame.prev);
      __global.__frame = __frame;
      return __propagate(_, e);
  ...
  return (function __$__$main(__then) {
    if ((process.argv[1] && (process.argv[1].indexOf("/docTool") >= 0))) {
      return exports.generate(__cb(_, __frame, 75, 1, __then), fsp.join(process.cwd(), (process.argv[2] || ".")), {
        verbose: true
      });
    }
     else {
