...
(function __$main(_) {
  ...
  exports.generate = function exports_generate__1(_, path, options) {
    function _generate(_, path) {
      ...
      __func(_, this, arguments, _generate, 0, __frame, function __$_generate() {
    ...
    __func(_, this, arguments, exports_generate__1, 0, __frame, function __$exports_generate__1() {
      options = (options || {
      });
