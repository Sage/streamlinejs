/*** Generated by streamline 0.1.46 - DO NOT EDIT ***/ "use strict"; var __rt=require('streamline/lib/callbacks/runtime')(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch,__propagate=__rt.__propagate,__trap=__rt.__trap,__future=__rt.__future,__setEF=__rt.__setEF,__g=__rt.__g; var fs = require("fs");
...
exports.compile = function exports_compile__2(_, paths, options) { var flows, failed, transform, cwd;
 ...
 function _compile(_, path, options) { var stat; var __frame = { name: "_compile", line: 252 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
 return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __2) { stat = __2; return (function __$_compile(__then) {
 if (stat.isDirectory()) {
 return fs.readdir(path, __cb(_, __frame, 3, 17, function ___(__0, __3) { return flows.each(__cb(_, __frame, 3, 3, __then), __3, function __1(_, f) { var __frame = { name: "__1", line: 255 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
