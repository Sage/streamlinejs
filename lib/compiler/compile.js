...
exports.loadFile = function exports_loadFile__1(_, path, options) { var ext, basename, dirname, mtimejs, mtimejs_, dontSave, jsbase, js, js_, fiberjs, transform, banner, content, shebangparse, shebang, le, transformed, matches; var __frame = { name: "exports_loadFile__1", line: 95 }; return __func(_, this, arguments, exports_loadFile__1, 0, __frame, function __$exports_loadFile__1() {
 ...
 content = ((content.substring(0, matches.index) + "'STREAMLINED'") + content.substring((matches.index + matches[0].length)));
...
function mkdirs(_, path) { var p, i; var __frame = { name: "mkdirs", line: 267 }; return __func(_, this, arguments, mkdirs, 0, __frame, function __$mkdirs() {
 p = ""; i = 0;
 path.split("/").slice(0, -1).forEach(function(seg) {
 p += (((i++ ? "/" : "")) + seg);
 if (((i > 1) && !fspath.existsSync(p))) { fs.mkdirSync(p, dirMode); }; }); _(); });};
...
function cachedTransform(_, content, path, transform, banner, options) { var i, dir, f, transformed; var __frame = { name: "cachedTransform", line: 275 }; return __func(_, this, arguments, cachedTransform, 0, __frame, function __$cachedTransform() {
 ...
 return fs.writeFile(f, transformed, "utf8", __cb(_, __frame, 19, 2, __then)); } else { __then(); } ; })(function __$cachedTransform() {
 return _(null, transformed); }); }); }), path); }), f); }), f); });};


function mkdirsSync(path) {
 var p = "";
 path.split("/").slice(1, -1).forEach(function(seg) {
 p += ("/" + seg);
...
exports.compile = function exports_compile__2(_, paths, options) { var flows, failed, transform, cwd;
 ...
 function _compile(_, path, options) { var stat; var __frame = { name: "_compile", line: 338 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
 return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __2) { stat = __2; return (function __$_compile(__then) {
 if (stat.isDirectory()) {
 return fs.readdir(path, __cb(_, __frame, 3, 17, function ___(__0, __3) { return flows.each(__cb(_, __frame, 3, 3, __then), __3, function __1(_, f) { var __frame = { name: "__1", line: 341 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); })); }); }; var __frame = { name: "exports_compile__2", line: 335 }; return __func(_, this, arguments, exports_compile__2, 0, __frame, function __$exports_compile__2() { flows = require("../util/flows");
 ...
 if (failed) {
 return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }), paths, function __1(_, path) { var __frame = { name: "__1", line: 363 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _), fspath.resolve(cwd, path), options); }); }); });};
