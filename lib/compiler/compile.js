...
exports.compileFile = function exports_compileFile__1(_, js_, options) { var ext, language, basename, dirname, js, mtimejs_, mtimejs, transform, banner, content, shebangparse, shebang, le, coffee, transformed; var __frame = { name: "exports_compileFile__1", line: 73 }; return __func(_, this, arguments, exports_compileFile__1, 0, __frame, function __$exports_compileFile__1() {
 ...
 var __1 = mtimejs; if (!__1) { return _(null, __1); } ; return fs.readFile(js, "utf8", __cb(_, __frame, 25, 30, _, true)); })(__cb(_, __frame, -72, 6, function ___(__0, __5) { transformed = __5;
...
exports.loadFile = function exports_loadFile__2(_, path, options) { var ext, basename, dirname, mtimejs, mtimejs_, dontSave, jsbase, js, js_, fiberjs, transform, banner, content, shebangparse, shebang, le, transformed, matches; var __frame = { name: "exports_loadFile__2", line: 127 }; return __func(_, this, arguments, exports_loadFile__2, 0, __frame, function __$exports_loadFile__2() {
 ...
 var __1 = options.fibers; if (!__1) { return _(null, __1); } ; return mtime(__cb(_, __frame, 19, 34, function ___(__0, __3) { var __2 = (mtimejs = __3); return _(null, __2); }, true), fiberjs); })(__cb(_, __frame, -126, 6, function ___(__0, __5) { return (function __$exports_loadFile__2(__then) { if (__5) {
 ...
 var __2 = mtimejs; if (!__2) { return _(null, __2); } ; return fs.readFile(js, "utf8", __cb(_, __frame, 38, 31, _, true)); })(__cb(_, __frame, -126, 6, function ___(__0, __9) { transformed = __9;
 if ((((transformed && (mtimejs_ < mtimejs)) && (transformed.substring(0, banner.length) == banner)) && !options.force)) {
 return _(null, transformed); } ;
