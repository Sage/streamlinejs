...
function _mkdir(dir, mode, _) { var p; var __frame = { name: "_mkdir", line: 21 }; __func(_, this, arguments, _mkdir, 2, __frame, function __$_mkdir() {
...
function mtime(_, fname) { var __frame = { name: "mtime", line: 28 }; __func(_, this, arguments, mtime, 0, __frame, function __$mtime() { return (function __$mtime(_) {
...
exports.loadFile = function exports_loadFile__1(_, path, options) { var dontSave, js, js_, mtimejs, mtimejs_, banner, content, transformed; var __frame = { name: "exports_loadFile__1", line: 44 }; __func(_, this, arguments, exports_loadFile__1, 0, __frame, function __$exports_loadFile__1() {
...
exports.compile = function exports_compile__2(_, paths, options) { var failed, cwd;
 function _compile(_, path, options) { var stat, js; var __frame = { name: "_compile", line: 157 }; __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
 return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __2) { stat = __2; return (function __$_compile(__then) {
 if (stat.isDirectory()) {
 return fs.readdir(path, __cb(_, __frame, 3, 17, function ___(__0, __3) { return flows.each(__cb(_, __frame, 3, 3, __then), __3, function __1(_, f) { var __frame = { name: "__1", line: 160 }; __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); })); }); }; var __frame = { name: "exports_compile__2", line: 156 }; __func(_, this, arguments, exports_compile__2, 0, __frame, function __$exports_compile__2() {
 ...
 if (failed) {
 return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }), paths, function __1(_, path) { var __frame = { name: "__1", line: 182 }; __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _), fspath.join(cwd, path), options); }); }); });};