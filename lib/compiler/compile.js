...
exports.compile = function exports_compile__3(_, paths, options) { var flows, failed, transform, cwd;
 ...
 if (stat.isDirectory()) {
 return fs.readdir(path, __cb(_, __frame, 3, 17, function ___(__0, __3) { return flows.each(__cb(_, __frame, 3, 3, __then, true), __3, function __1(_, f) { var __frame = { name: "__1", line: 361 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); }, true)); }); }; var __frame = { name: "exports_compile__3", line: 354 }; return __func(_, this, arguments, exports_compile__3, 0, __frame, function __$exports_compile__3() { flows = require("../util/flows");
 ...
 if (failed) { return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }, true), paths, function __1(_, path) { var __frame = { name: "__1", line: 387 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _, true), fspath.resolve(cwd, path), options); }); }); });};