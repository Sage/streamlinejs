...
function mtime(_, fname) { var __frame = { name: "mtime", line: 28 }; return __func(_, this, arguments, mtime, 0, __frame, function __$mtime() { return (function __$mtime(_) {
 return _exists(__cb(_, __frame, 1, 8, function ___(__0, __1) { var __2 = __1; return (function __$mtime(__then) { if (__2) { return fs.stat(fname, __cb(_, __frame, 1, 28, function ___(__0, __4) { var __3 = __4.mtime; return _(null, __3); })); } else { __then(); } ; })(function __$mtime() { return _(null, 0); }); }), fname); })(__cb(_, __frame, -20, 26, _)); });};
...
exports.loadFile = function exports_loadFile__1(_, path, options) { var dontSave, js, js_, mtimejs, mtimejs_, banner, content, transformed; var __frame = { name: "exports_loadFile__1", line: 44 }; return __func(_, this, arguments, exports_loadFile__1, 0, __frame, function __$exports_loadFile__1() {
 ...
 var __1 = mtimejs; if (!__1) { return _(null, __1); } ; return fs.readFile(js, "utf8", __cb(_, __frame, 23, 31, _)); })(__cb(_, __frame, -36, 26, function ___(__0, __5) { transformed = __5;
...
exports.compile = function exports_compile__2(_, paths, options) { var failed, cwd;
 ...
 if (failed) {
 return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }), paths, function __1(_, path) { var __frame = { name: "__1", line: 182 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _), fspath.join(cwd, path), options); }); }); });};