...
exports.loadFile = function exports_loadFile__1(_, path, options) { var ext, basename, dirname, mtimejs, mtimejs_, dontSave, jsbase, js, js_, fiberjs, transform, banner, content, shebangparse, shebang, le, transformed, matches; var __frame = { name: "exports_loadFile__1", line: 95 }; return __func(_, this, arguments, exports_loadFile__1, 0, __frame, function __$exports_loadFile__1() {
 ...
 return cachedTransform(__cb(_, __frame, 66, 10, _), content, path, transform, banner, options); } else {
...
function mkdirs(_, path) { var p, i; var __frame = { name: "mkdirs", line: 261 }; return __func(_, this, arguments, mkdirs, 0, __frame, function __$mkdirs() {
 p = ""; i = 0;
...
function cachedTransform(_, content, path, transform, banner, options) { var i, dir, f, transformed; var __frame = { name: "cachedTransform", line: 269 }; return __func(_, this, arguments, cachedTransform, 0, __frame, function __$cachedTransform() {
 path = path.replace(/\\/g, "/");
 ...
 return fs.writeFile(f, transformed, "utf8", __cb(_, __frame, 21, 2, __then)); } else { __then(); } ; })(function __$cachedTransform() {
