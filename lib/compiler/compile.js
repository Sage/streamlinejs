...
var streamlineRE = /if\s*\(\s*!\s*require\s*\(\s*['"]streamline\/module['"]\s*\)\s*\(\s*module\s*,\s*([^)]*)\s*\)\s*\)\s*return\s*;/;
...
exports.loadFile = function exports_loadFile__1(_, path, options) { var ext, basename, dirname, mtimejs, mtimejs_, dontSave, jsbase, js, js_, fiberjs, transform, banner, content, shebangparse, shebang, le, transformed, matches; var __frame = { name: "exports_loadFile__1", line: 95 }; return __func(_, this, arguments, exports_loadFile__1, 0, __frame, function __$exports_loadFile__1() {
 ...
 var __1 = options.fibers; if (!__1) { return _(null, __1); } ; return mtime(__cb(_, __frame, 14, 34, function ___(__0, __3) { var __2 = (mtimejs = __3); return _(null, __2); }), fiberjs); })(__cb(_, __frame, -94, 21, function ___(__0, __3) { return (function __$exports_loadFile__1(__then) { if (__3) {
 ...
 var __2 = mtimejs; if (!__2) { return _(null, __2); } ; return fs.readFile(js, "utf8", __cb(_, __frame, 34, 31, _)); })(__cb(_, __frame, -94, 21, function ___(__0, __7) { transformed = __7;
 ...
 return fs.readFile(js, "utf8", __cb(_, __frame, 57, 16, function ___(__0, __8) { content = __8; return (function __$exports_loadFile__1(__then) {
 ...
 return _(null, transform.transform(content, options)); } else { return (function __$exports_loadFile__1(__then) {
 ...
 return cachedTransform(__cb(_, __frame, 72, 10, _), content, path, transform, banner, options); } else {

 return _(null, content); } ; })(__then); } ; })(__then); })); } ; })(_); }), js_); }); })); });};
...
function mkdirs(_, path) { var p; var __frame = { name: "mkdirs", line: 267 }; return __func(_, this, arguments, mkdirs, 0, __frame, function __$mkdirs() {
 p = "";
 path.split("/").slice(0, -1).forEach(function(seg) {
 p += ("/" + seg);
 if (!fspath.existsSync(p)) { fs.mkdirSync(p, dirMode); }; }); _(); });};
...
function cachedTransform(_, content, path, transform, banner, options) { var i, dir, f, transformed; var __frame = { name: "cachedTransform", line: 275 }; return __func(_, this, arguments, cachedTransform, 0, __frame, function __$cachedTransform() {
 ...
 return mkdirs(__cb(_, __frame, 8, 1, function __$cachedTransform() {

 return mtime(__cb(_, __frame, 10, 5, function ___(__0, __2) { return mtime(__cb(_, __frame, 10, 19, function ___(__0, __3) { var __1 = (__2 > __3); return (function __$cachedTransform(__then) { if (__1) {
 return fs.readFile(f, "utf8", __cb(_, __frame, 11, 16, function ___(__0, __4) { transformed = __4;
 if ((transformed.substring(0, banner.length) === banner)) {
 return _(null, transformed); } ; __then(); })); } else { __then(); } ; })(function __$cachedTransform() {


 transformed = (banner + _transform(transform, content, options)); return (function __$cachedTransform(__then) {
 if ((path.indexOf("/tmp--") < 0)) {
 return fs.writeFile(f, transformed, "utf8", __cb(_, __frame, 18, 2, __then)); } else { __then(); } ; })(function __$cachedTransform() {
...
exports.compile = function exports_compile__2(_, paths, options) { var flows, failed, transform, cwd;
 ...
 function _compile(_, path, options) { var stat; var __frame = { name: "_compile", line: 336 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
 return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __2) { stat = __2; return (function __$_compile(__then) {
 if (stat.isDirectory()) {
 return fs.readdir(path, __cb(_, __frame, 3, 17, function ___(__0, __3) { return flows.each(__cb(_, __frame, 3, 3, __then), __3, function __1(_, f) { var __frame = { name: "__1", line: 339 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); })); }); }; var __frame = { name: "exports_compile__2", line: 333 }; return __func(_, this, arguments, exports_compile__2, 0, __frame, function __$exports_compile__2() { flows = require("../util/flows");
 ...
 if (failed) {
 return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }), paths, function __1(_, path) { var __frame = { name: "__1", line: 361 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _), fspath.resolve(cwd, path), options); }); }); });};
