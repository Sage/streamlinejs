...
exports.loadFile = function exports_loadFile__1(_, path, options) { var ext, basename, dirname, js, js_, dontSave, mtimejs, mtimejs_, banner, content, shebangparse, shebang, transformed; var __frame = { name: "exports_loadFile__1", line: 57 }; return __func(_, this, arguments, exports_loadFile__1, 0, __frame, function __$exports_loadFile__1() {
 options = (options || { });
 ...
 return mtime(__cb(_, __frame, 25, 15, function ___(__0, __2) { mtimejs = __2;
 return mtime(__cb(_, __frame, 26, 16, function ___(__0, __3) { mtimejs_ = __3;

 banner = transform.banner(); return (function __$exports_loadFile__1(__then) {

 if (mtimejs_) {
 return fs.readFile(js_, "utf8", __cb(_, __frame, 31, 16, function ___(__0, __4) { content = __4;
 shebangparse = parseShebang(content);
 shebang = shebangparse[0];
 content = shebangparse[1];
 banner = (shebang + banner); return (function __$exports_loadFile__1(_) {
 var __1 = mtimejs; if (!__1) { return _(null, __1); } ; return fs.readFile(js, "utf8", __cb(_, __frame, 36, 31, _)); })(__cb(_, __frame, -56, 22, function ___(__0, __5) { transformed = __5;
 ...
 return fs.readFile(js, "utf8", __cb(_, __frame, 58, 16, function ___(__0, __6) { content = __6;
...
exports.compile = function exports_compile__2(_, paths, options) { var flows, failed, cwd;
 ...
 function _compile(_, path, options) { var stat, js; var __frame = { name: "_compile", line: 211 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
 return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __2) { stat = __2; return (function __$_compile(__then) {
 if (stat.isDirectory()) {
 return fs.readdir(path, __cb(_, __frame, 3, 17, function ___(__0, __3) { return flows.each(__cb(_, __frame, 3, 3, __then), __3, function __1(_, f) { var __frame = { name: "__1", line: 214 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); })); }); }; var __frame = { name: "exports_compile__2", line: 208 }; return __func(_, this, arguments, exports_compile__2, 0, __frame, function __$exports_compile__2() { flows = require("../util/flows");
 ...
 if (failed) {
 return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }), paths, function __1(_, path) { var __frame = { name: "__1", line: 236 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _), fspath.join(cwd, path), options); }); }); });};