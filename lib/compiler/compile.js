...
exports.compileFile = function exports_compileFile__1(_, js_, options) { var ext, language, basename, dirname, js, mtimejs_, mtimejs, transform, banner, content, shebangparse, shebang, le, coffee, transformed; var __frame = { name: "exports_compileFile__1", line: 74 }; return __func(_, this, arguments, exports_compileFile__1, 0, __frame, function __$exports_compileFile__1() {
 ...
 var __1 = mtimejs; if (!__1) { return _(null, __1); } ; return fs.readFile(js, "utf8", __cb(_, __frame, 25, 30, _, true)); })(__cb(_, __frame, -73, 6, function ___(__0, __5) { transformed = __5;
...
exports.loadFile = function exports_loadFile__2(_, path, options) { var ext, basename, dirname, mtimejs, mtimejs_, dontSave, jsbase, js, js_, fiberjs, transform, banner, content, shebangparse, shebang, le, transformed, matches; var __frame = { name: "exports_loadFile__2", line: 128 }; return __func(_, this, arguments, exports_loadFile__2, 0, __frame, function __$exports_loadFile__2() {
 ...
 var __1 = options.fibers; if (!__1) { return _(null, __1); } ; return mtime(__cb(_, __frame, 19, 34, function ___(__0, __3) { var __2 = (mtimejs = __3); return _(null, __2); }, true), fiberjs); })(__cb(_, __frame, -127, 6, function ___(__0, __5) { return (function __$exports_loadFile__2(__then) { if (__5) {
 ...
 var __2 = mtimejs; if (!__2) { return _(null, __2); } ; return fs.readFile(js, "utf8", __cb(_, __frame, 38, 31, _, true)); })(__cb(_, __frame, -127, 6, function ___(__0, __9) { transformed = __9;
 if ((((transformed && (mtimejs_ < mtimejs)) && (transformed.substring(0, banner.length) == banner)) && !options.force)) {
 return _(null, transformed); } ;
...
function mkdirs(_, path) { var p, i, segs, seg; var __frame = { name: "mkdirs", line: 281 }; return __func(_, this, arguments, mkdirs, 0, __frame, function __$mkdirs() {
 p = "";
 i = 0;
 ...
 var __1 = (i > 1); if (!__1) { return _(null, __1); } ; return _exists(__cb(_, __frame, 7, 16, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true), p); })(__cb(_, __frame, -280, 6, function ___(__0, __2) { return (function __$mkdirs(__then) { if (__2) { return fs.mkdir(p, dirMode, __cb(_, __frame, 7, 31, __then, true)); } else { __then(); } ; })(function __$mkdirs() { while (__more) { __loop(); }; __more = true; }); }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(_); });};
...
function cachedTransform(_, content, path, transform, banner, options) { var i, dir, f, transformed; var __frame = { name: "cachedTransform", line: 296 }; return __func(_, this, arguments, cachedTransform, 0, __frame, function __$cachedTransform() {
 path = path.replace(/\\/g, "/");
...
exports.compile = function exports_compile__3(_, paths, options) { var failed, transform, cwd;
 function _compile(_, path, options) { var stat, ext; var __frame = { name: "_compile", line: 363 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
 return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __2) { stat = __2; return (function __$_compile(__then) {
 if (stat.isDirectory()) {
 return fs.readdir(path, __cb(_, __frame, 3, 3, function ___(__0, __3) { return __3.forEach_(__cb(_, __frame, 3, 3, __then, true), function __1(_, f) { var __frame = { name: "__1", line: 366 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); }, true)); }); }; var __frame = { name: "exports_compile__3", line: 362 }; return __func(_, this, arguments, exports_compile__3, 0, __frame, function __$exports_compile__3() {
 ...
 if (failed) { return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }, true), function __1(_, path) { var __frame = { name: "__1", line: 392 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _, true), fspath.resolve(cwd, path), options); }); }); });};