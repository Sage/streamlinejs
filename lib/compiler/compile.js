...
function mkdirs(_, path) { var p, i, segs, seg; var __frame = { name: "mkdirs", line: 284 }; return __func(_, this, arguments, mkdirs, 0, __frame, function __$mkdirs() {
 p = "";
 i = 0;
 ...
 var __1 = (i > 1); if (!__1) { return _(null, __1); } ; return _exists(__cb(_, __frame, 7, 16, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true), p); })(__cb(_, __frame, -283, 6, function ___(__0, __2) { return (function __$mkdirs(__then) { if (__2) { return fs.mkdir(p, dirMode, __cb(_, __frame, 7, 31, __then, true)); } else { __then(); } ; })(function __$mkdirs() { while (__more) { __loop(); }; __more = true; }); }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(_); });};
...
exports.compile = function exports_compile__3(_, paths, options) { var failed, transform, cwd;
 function _compile(_, path, options) { var stat, ext, coffee, compiled, jsPath; var __frame = { name: "_compile", line: 371 }; return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
 return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __2) { stat = __2; return (function __$_compile(__then) {
 if (stat.isDirectory()) {
 return fs.readdir(path, __cb(_, __frame, 3, 3, function ___(__0, __3) { return __3.forEach_(__cb(_, __frame, 3, 3, __then, true), function __1(_, f) { var __frame = { name: "__1", line: 374 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 ...
 coffee = require("coffee-script");
 return fs.readFile(path, "utf8", __cb(_, __frame, 14, 35, function ___(__0, __4) { compiled = coffee.compile(__4, {
 filename: path });

 jsPath = (path.substring(0, (path.length - ext.length)) + ".js");
 return fs.writeFile(jsPath, compiled, "utf8", __cb(_, __frame, 18, 5, __then, true)); }, true)); } else {

 return exports.loadFile(__cb(_, __frame, 20, 5, __then, true), path, options); } ; })(__then); } ; })(__then); }, true), path, options); }); })(function ___(ex, __result) { __tryCatch(_, function __$_compile() { if (ex) {


 console.error(ex.stack);
 failed++; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); } ; })(_); }, true)); }); }; var __frame = { name: "exports_compile__3", line: 370 }; return __func(_, this, arguments, exports_compile__3, 0, __frame, function __$exports_compile__3() {
 ...
 cwd = process.cwd();
 return paths.forEach_(__cb(_, __frame, 37, 1, function __$exports_compile__3() {


 if (failed) { return _(new Error((("errors found in " + failed) + " files"))); } ; _(); }, true), function __1(_, path) { var __frame = { name: "__1", line: 407 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _compile(__cb(_, __frame, 1, 2, _, true), fspath.resolve(cwd, path), options); }); }); });};