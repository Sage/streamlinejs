...
;
  ...
  try {
    ...
    return _exists(p, __cb(_, __frame, 2, 1, function ___(__0, __2) {
      var __1 = !__2;
      return (function __$_mkdir(__then) {
        if (__1) {
          return _mkdir(p, mode, __cb(_, __frame, 3, 1, __then));
        }
         else {
          __then();
        }
...
;
  ...
  try {
    return (function __$mtime(_) {
      return _exists(__cb(_, __frame, 1, 1, function ___(__0, __1) {
        var __2 = __1;
        return (function __$mtime(__then) {
          if (__2) {
            return fs.stat(fname, __cb(_, __frame, 1, 1, function ___(__0, __4) {
              var __3 = __4.mtime;
              return _(null, __3);
            }));
          }
...
;
  ...
  ;
    js = (path + ".js");
    js_ = (path + "_.js");
    return mtime(__cb(_, __frame, 16, 1, function ___(__0, __2) {
      mtimejs = __2;
      return mtime(__cb(_, __frame, 17, 1, function ___(__0, __3) {
        mtimejs_ = __3;
        banner = transform.banner();
        return (function __$Object$loadFile(__then) {
          if (mtimejs_) {
            return fs.readFile(js_, "utf8", __cb(_, __frame, 22, 1, function ___(__0, __4) {
              content = __4;
              ...
              ;
                return fs.readFile(js, "utf8", __cb(_, __frame, 23, 1, _));
              })(__cb(_, __frame, -36, 1, function ___(__0, __5) {
                transformed = __5;
                    ...
                    return (function ___(__then) {
                      (function ___(_) {
                        __tryCatch(_, function __$Object$loadFile() {
                          return fs.writeFile(js, transformed, "utf8", __cb(_, __frame, 35, 1, __then));
                        });
            ...
            return fs.readFile(js, "utf8", __cb(_, __frame, 43, 1, _));
          }
        ;
        })(_);
      }), js_);
...
;
  ...
  ;
    ...
    try {
      var stat, js;
      return fs.stat(path, __cb(_, __frame, 1, 1, function ___(__0, __2) {
        stat = __2;
        return (function __$_compile(__then) {
          if (stat.isDirectory()) {
            return fs.readdir(path, __cb(_, __frame, 3, 1, function ___(__0, __3) {
              return flows.each(__cb(_, __frame, 3, 1, __then), __3, function __1(_, f) {
                if (!_) {
              ...
              ;
                ...
                try {
                  return _compile(__cb(_, __frame, 1, 1, _), ((path + "/") + f), options);
                } catch (e) {
                  e.__frame = (e.__frame || __frame.prev);
                  __global.__frame = __frame;
                  return __propagate(_, e);
                ...
                return (function ___(__then) {
                  (function ___(_) {
                    __tryCatch(_, function __$_compile() {
                      ...
                      return exports.loadFile(__cb(_, __frame, 9, 1, __then), js, options);
                    });
                  })(function ___(ex, __result) {
                    __tryCatch(_, function __$_compile() {
                      if (ex) {
  ...
  ;
    cwd = process.cwd;
    return flows.each(__cb(_, __frame, 26, 1, function __$Object$compile() {
      if (failed) {
    ...
    ;
      ...
      try {
        return _compile(__cb(_, __frame, 1, 1, _), fspath.join(cwd, path), options);
      } catch (e) {
        e.__frame = (e.__frame || __frame.prev);
        __global.__frame = __frame;
        return __propagate(_, e);
