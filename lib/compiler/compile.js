...
;
  ...
  return _exists(p, __cb(_, function ___(__0, __2) {
    var __1 = !__2;
    return (function __$_mkdir(__then) {
      if (__1) {
        return _mkdir(p, mode, __cb(_, function __$_mkdir() {
          __then();
        }));
      }
       else {
    ...
    ;
      ...
      return fs.mkdir(dir, mode, __cb(_, function __$_mkdir() {
        _();
      }));
    });
  }));
  ...
  return (function ___(_) {
    return _exists(__cb(_, function ___(__0, __1) {
      ...
      return (function __$undefined(__then) {
        if (__2) {
          return fs.stat(fname, __cb(_, function ___(__0, __4) {
            var __3 = __4.mtime;
            return _(null, __3);
          }));
        }
...
;
  js = (path + ".js");
  js_ = (path + "_.js");
  return mtime(__cb(_, function ___(__0, __2) {
    mtimejs = __2;
    return mtime(__cb(_, function ___(__0, __3) {
      mtimejs_ = __3;
      banner = transform.banner();
      return (function __$__1(__then) {
        if (mtimejs_) {
          return fs.readFile(js_, "utf8", __cb(_, function ___(__0, __4) {
            content = __4;
            return (function ___(_) {
              var __1 = mtimejs;
              if (!__1) {
                  ...
                  return (function ___(__then) {
                    (function ___(_) {
                      __tryCatch(_, function __$__1() {
                        return fs.writeFile(js, transformed, "utf8", __cb(_, function __$__1() {
                          __then();
                        }));
                      });
...
;
  ...
  ;
    var stat, js;
    return fs.stat(path, __cb(_, function ___(__0, __2) {
      stat = __2;
      return (function __$_compile(__then) {
        if (stat.isDirectory()) {
          return fs.readdir(path, __cb(_, function ___(__0, __3) {
            return flows.each(__cb(_, function __$_compile() {
              __then();
            }), __3, function __1(_, f) {
              if (!_) {
                return __future(__1, arguments, 0);
              }
            ;
              return _compile(__cb(_, function __$__1() {
                _();
              }), ((path + "/") + f), options);
            });
          }));
              ...
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$_compile() {
                    ...
                    return exports.loadFile(__cb(_, function __$_compile() {
                      __then();
                    }), js, options);
                  });
                })(function ___(ex, __result) {
...
;
  cwd = process.cwd;
  return flows.each(__cb(_, function __$__2() {
    if (failed) {
