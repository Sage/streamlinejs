...
(function(exports) {
	...
	var isFast = /-fast$/.test(require('streamline/lib/globals').runtime);
	...
	exports.funnel = function(max) {
		...
		var fun = isFast ? function(_, fn) {
			return funCb(~_, fn);
		} : funCb;
		// temp fix for performance issue with futures in fibers fast mode
		fun.rawFunction = funCb;
