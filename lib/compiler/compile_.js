...
exports.installRuntime = function(dir) {
	...
	if (!fspath.existsSync(cwd + '/node_modules/')) {
		throw new Error("Error: could not find node_modules in the current directory. please change " +
										"directories to where the runtime should be installed or create a node_modules folder.\n\n" +
