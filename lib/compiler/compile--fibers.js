/*** Generated by streamline fibers 0.2.0 - DO NOT EDIT ***/var fstreamline__ = require("streamline/lib/fibers/runtime"); (fstreamline__.create(function(_) {var mtime_ = fstreamline__.create(mtime), mkdirs_ = fstreamline__.create(mkdirs), cachedTransform_ = fstreamline__.create(cachedTransform); //streamline.options = { "lines" : "preserve" }
"use strict";
...
function mkdirs(_, path) {
	...
	while (i < segs.length) {
		var seg = segs[i];
		p += (i++ ? '/' : '') + seg;
		if (i > 1 && !fstreamline__.invoke(null, _exists, [_, p], 0)) fstreamline__.invoke(fs, "mkdir", [p, dirMode, _], 2);
	}
}
