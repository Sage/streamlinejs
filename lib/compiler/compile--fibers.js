/*** Generated by streamline fibers 0.1.0 - DO NOT EDIT ***/var fstreamline__ = require("streamline/lib/fibers/runtime"); (fstreamline__.create(function(_) {var mtime_ = fstreamline__.create(mtime), mkdirs_ = fstreamline__.create(mkdirs), cachedTransform_ = fstreamline__.create(cachedTransform); //streamline.options = { "lines" : "preserve" }
"use strict";
