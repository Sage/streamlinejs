/*** Generated by streamline fibers 0.2.4 - DO NOT EDIT ***/var fstreamline__ = require("streamline/lib/fibers/runtime"); (fstreamline__.create(function(_) {var mtime_ = fstreamline__.create(mtime), mkdirs_ = fstreamline__.create(mkdirs), cachedTransform_ = fstreamline__.create(cachedTransform); //streamline.options = { "lines" : "preserve" }
"use strict";
...
exports.compileFile = fstreamline__.create(function(_, js_, options) {
		...
		if (stat.isDirectory()) {
			...
			try {
				...
				if (ext === "._js" || ext === "._coffee") {
					fstreamline__.invoke(exports, "compileFile", [_, path, options], 0);
				} else {
					fstreamline__.invoke(exports, "loadFile", [_, path, options], 0);
				}
			} catch (ex) {
