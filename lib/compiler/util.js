...
exports.getOptions = function(options) {
	...
	Object.keys(options = options || {}).forEach(function(opt) {
		if (/^(fast)$/.test(opt)) {
			console.warn("[STREAMLINE] Ignoring obsolete option: " + opt);
			return;
		}
...
exports.deprecate = function(module, message) {
	console.warn("Module " + module.id + " is deprecated: " + message);
	Object.keys(module.exports).forEach(function(name) {
		var fn = module.exports[name];
		if (typeof fn === 'function') {
			module.exports[name] = function() {
				if (!module.exports[name].warned) console.warn("Module " + module.id + ": calling deprecated function: " + name);
