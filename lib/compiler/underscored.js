...
function run(options) {
	...
	var streamliners = {
		...
		_coffee: function(module, filename, code) {
			...
			// TODO Can we centralize the require() call and have it work
			// relative to the cwd instead of this module's location?
	...
	// TODO Just like the streamliner above, can we centralize the require()
	// and have it work relative to the cwd instead of this module's location?
	if (coffeePresent) require('coffee-script');
	...
	streamliners[coffeePresent ? '_coffee' : '_js'](mainModule, filename);
}
