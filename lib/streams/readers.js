...
exports.Reader = function(stream, boundary, options) {
 ...
 if (!boundary) {
 boundary = "\n"; };
 this.readItem = function readItem__1(_) { var chunks, len, chunk, i; var __frame = { name: "readItem__1", line: 28 }; __func(_, this, arguments, readItem__1, 0, __frame, function() {
 chunks = [];
 ...
 this.close = function close__2(_) { var __frame = { name: "close__2", line: 51 }; __func(_, this, arguments, close__2, 0, __frame, function() {
 stream = null; _(); }); };};