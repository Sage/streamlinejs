...
;
  ...
  this.parseBody = function Object$parseBody(_) {
    if (!_) {
      return __future(Object$parseBody, arguments, 0);
    }
  ;
    var __frame = new __Frame(131, "Object$parseBody");
    try {
      var ct, str;
    ...
    ;
      return request.readAll(__cb(_, __frame, 8, 12, function ___(__0, __1) {
        str = __1;
        if ((str == null)) {
          return _(null, null);
        }
