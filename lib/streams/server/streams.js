...
function ReadableStream(emitter, options) {
 ...
 return _reply(callback, null, null); } else {
 if (_error) {
 return _reply(callback, _error); } else {
 ...
 this.read = function read__1(_, len) { var chunks, total, chunk, __this = this; var __frame = { name: "read__1", line: 227 }; return __func(_, this, arguments, read__1, 0, __frame, function __$read__1() {
 if (!emitter) {
 ...
 this.readAll = function readAll__2(_) { var __this = this; var __frame = { name: "readAll__2", line: 255 }; return __func(_, this, arguments, readAll__2, 0, __frame, function __$readAll__2() {
...
function WritableStream(emitter, options) {
 ...
 this.write = function write__1(_, data, enc) { var __this = this; var __frame = { name: "write__1", line: 303 }; return __func(_, this, arguments, write__1, 0, __frame, function __$write__1() {
...
function HttpServer(requestListener, options) {
 ...
 this.listen = function listen__1(_, args) { var __arguments = arguments; var __frame = { name: "listen__1", line: 423 }; return __func(_, this, arguments, listen__1, 0, __frame, function __$listen__1() {
...
function HttpClientRequest(options) {
 ...
 this.response = function response__1(_) { var __frame = { name: "response__1", line: 556 }; return __func(_, this, arguments, response__1, 0, __frame, function __$response__1() {
...
function NetClient(options, args) {
 ...
 this.connect = function connect__1(_) { var __frame = { name: "connect__1", line: 638 }; return __func(_, this, arguments, connect__1, 0, __frame, function __$connect__1() {
