...
function ReadableStream(emitter, options) {
  ...
  this.read = function Object$read(_, len) {
    if (!_) {
      return __future.call(this, Object$read, arguments, 0);
    }
  ;
    var __frame = new __Frame(227, "Object$read");
    try {
    ...
    ;
      return (function __$Object$read(__then) {
        if ((len == null)) {
          return readChunk(__cb(_, __frame, 4, 10, _));
        }
         else {
          __then();
        }
      ;
      })(function __$Object$read() {
        if ((len < 0)) {
          len = Infinity;
        }
      ;
      ...
      ;
        ...
        return (function ___(__break) {
          var __loop = __nt(_, __frame, function __$Object$read() {
            var __4 = (total < len);
            if (__4) {
              return readChunk(__cb(_, __frame, 11, 15, function ___(__0, __2) {
                chunk = __2;
                if (!chunk) {
  ...
  ;
    var __frame = new __Frame(255, "Object$readAll");
    try {
      var __this = this;
...
function WritableStream(emitter, options) {
  ...
  ;
    var __frame = new __Frame(303, "Object$write");
    try {
      var __this = this;
      checkOpen(emitter);
      return (function __$Object$write(__then) {
        if (!emitter.write(data, enc)) {
          return _drain(__cb(_, __frame, 3, 3, __then));
        }
         else {
          __then();
        }
      ;
      })(function __$Object$write() {
