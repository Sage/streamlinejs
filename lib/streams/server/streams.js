...
function ReadableStream(emitter, options) {
 ...
 if ((len == null)) {
 return readChunk(_); } else { __then(); } ; })(function __$read__1() {
 if ((len < 0)) {
 len = Infinity; } ;
 if ((len == 0)) {
...
function HttpClientRequest(options) {
 ...
 if (_done) {
 return _reply(callback, _error, _response); } else {
...
function NetClient(options, args) {
 ...
 if (_done) {
 return _reply(callback, _error, new NetStream(_connection, options)); } else {
