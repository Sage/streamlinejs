...
function ReadableStream(emitter, options) {
  ...
  this.read = function(_, len) {
    if (!_) {
      return __future.call(this, null, arguments, 0);
    }
  ;
    ...
    ;
      ...
      (function(__break) {
        var __loop = __nt(_, function() {
          var __6 = (total < len);
          if (__6) {
            return readChunk(__cb(_, function(__0, __4) {
              chunk = __4;
              if (!chunk) {
                return _(null, (function(_) {
                  var __2 = (chunks.length == 0);
                  if (__2) {
                    return _(null, null);
                  }
                ;
