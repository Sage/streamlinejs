...
function ReadableStream(emitter, options) {
  ...
  ;
    ...
    ;
      return (function __$Object$read(__then) {
        if ((len == null)) {
          return readChunk(__cb(_, __frame, 4, 1, _));
        }
         else {
          __then();
        }
      ...
      ;
        ...
        return (function ___(__break) {
          var __loop = __nt(_, __frame, function __$Object$read() {
            var __4 = (total < len);
            if (__4) {
              return readChunk(__cb(_, __frame, 11, 1, function ___(__0, __2) {
                chunk = __2;
                if (!chunk) {
  ...
  ;
    ...
    try {
      var __this = this;
      return __this.read(__cb(_, __frame, 1, 1, _), -1);
    } catch (e) {
      e.__frame = (e.__frame || __frame.prev);
      __global.__frame = __frame;
      return __propagate(_, e);
    ...
    try {
      ...
      return (function __$Object$write(__then) {
        if (!emitter.write(data, enc)) {
          return _drain(__cb(_, __frame, 3, 1, __then));
        }
         else {
          __then();
        }
