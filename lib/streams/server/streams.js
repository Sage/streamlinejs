...
function ReadableStream(emitter, options) {
 ...
 this.read = function read__1(_, len) { var chunks, total, chunk, __this = this; var __frame = { name: "read__1", line: 227 }; __func(_, this, arguments, read__1, 0, __frame, function __$read__1() {
 if (!emitter) {
 ...
 this.readAll = function readAll__2(_) { var __this = this; var __frame = { name: "readAll__2", line: 255 }; __func(_, this, arguments, readAll__2, 0, __frame, function __$readAll__2() {
...
function WritableStream(emitter, options) {
 ...
 this.write = function write__1(_, data, enc) { var __this = this; var __frame = { name: "write__1", line: 303 }; __func(_, this, arguments, write__1, 0, __frame, function __$write__1() {
