...
function ReadableStream(emitter, options) {
  ...
  this.read = function read__1(_, len) {
    if (!_) {
      return __future.call(this, read__1, arguments, 0);
    }
  ;
    var __frame = new __Frame(227, "read__1");
    try {
    ...
    ;
      return (function __$read__1(__then) {
        if ((len == null)) {
      ...
      ;
        ...
        return (function ___(__break) {
          var __loop = __nt(_, __frame, function __$read__1() {
            var __4 = (total < len);
            if (__4) {
  ...
  ;
    var __frame = new __Frame(255, "readAll__2");
    try {
      var __this = this;
...
function WritableStream(emitter, options) {
  ...
  this.write = function write__1(_, data, enc) {
    if (!_) {
      return __future.call(this, write__1, arguments, 0);
    }
  ;
    var __frame = new __Frame(303, "write__1");
    try {
      var __this = this;
      checkOpen(emitter);
      return (function __$write__1(__then) {
