...
(function(exports) {
	...
	exports.nextTick =  (function(unstarred__) {  function F(_) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_) {
		(yield galaxy.invoke(null, nextTick, [_], 0));
	}, 0));

	exports.collect = (function(unstarred__) {  function F(_, futures) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, futures) {
		return futures && (yield galaxy.invoke(futures, "map_", [_, (function(unstarred__) {  function F(_, future) {   return unstarred__.apply(this, arguments);  };  F.__starred__ = unstarred__.__starred__;  F.__starred__.__unstarred__ = F;  return F;})(galaxy.unstar(function*(_, future) {
