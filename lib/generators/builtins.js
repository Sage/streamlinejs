/*** Generated by streamline 0.4.10 (generators) - DO NOT EDIT ***/var fstreamline__ = require("streamline/lib/generators/runtime"); (fstreamline__.create(function*(_) { /**
...
(function(exports) {
	...
	Object.defineProperty(Array.prototype, 'forEach_', {
		...
		value: fstreamline__.create(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) (yield fstreamline__.invoke(fn, "call", [thisObj, _, this[i], i], 1));
				}
			} else {
				(yield fstreamline__.invoke(this, "map_", [_, par, fn, thisObj], 0));
			}
			yield ( this);
		}, 0)
	});
	...
	Object.defineProperty(Array.prototype, 'map_', {
		...
		value: fstreamline__.create(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) result[i] = (yield fstreamline__.invoke(fn, "call", [thisObj, _, this[i], i], 1));
				}
			} else {
				var fun = funnel(par);
				result = this.map(function(elt, i) {
					return fun(null, fstreamline__.create(function*(_) {
						yield ( (yield fstreamline__.invoke(fn, "call", [thisObj, _, elt, i], 1)));
					}, 0));
				});
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) result[i] = (yield fstreamline__.invoke(result, i, [_], 0));
				}
			}
			yield ( result);
		}, 0)
		...
		value: fstreamline__.create(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i)) {
						var elt = this[i];
						if ((yield fstreamline__.invoke(fn, "call", [thisObj, _, elt], 1))) result.push(elt);
					}
				}
			} else {
				(yield fstreamline__.invoke(this, "map_", [_, par, fstreamline__.create(function*(_, elt) {
					if ((yield fstreamline__.invoke(fn, "call", [thisObj, _, elt], 1))) result.push(elt);
				;yield undefined;}, 0), thisObj], 0));
			}
			yield ( result);
		}, 0)
	});
		...
		value: fstreamline__.create(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					...
					if (has.call(this, i) && !(yield fstreamline__.invoke(fn, "call", [thisObj, _, this[i]], 1))) yield ( false);
				}
			} else {
				var fun = funnel(par);
				var futures = this.map(function(elt) {
					return fun(null, fstreamline__.create(function*(_) {
						yield ( (yield fstreamline__.invoke(fn, "call", [thisObj, _, elt], 1)));
					}, 0));
				});
				for (var i = 0; i < len; i++) {
					if (has.call(this, i) && !(yield fstreamline__.invoke(futures, i, [_], 0))) {
						fun.close();
						yield ( false);
					}
				}
	...
	Object.defineProperty(Array.prototype, 'some_', {
		...
		value: fstreamline__.create(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				for (var i = 0; i < len; i++) {
					if (has.call(this, i) && (yield fstreamline__.invoke(fn, "call", [thisObj, _, this[i]], 1))) yield ( true);
				}
			} else {
				var fun = funnel(par);
				var futures = this.map(function(elt) {
	...
	Object.defineProperty(Array.prototype, 'reduce_', {
		...
		value: fstreamline__.create(function*(_, fn, v, thisObj) {
			...
			var len = this.length;
			for (var i = 0; i < len; i++) {
				if (has.call(this, i)) v = (yield fstreamline__.invoke(fn, "call", [thisObj, _, v, this[i], i, this], 1));
			}
			yield ( v);
		}, 0)
	});
	...
	Object.defineProperty(Array.prototype, 'sort_', {
		...
		writable: true,
		enumerable: false,
		value: fstreamline__.create(function*(_, compare, beg, end) {var _qsort_ = fstreamline__.create(_qsort, 0);
			var array = this;
			beg = beg || 0;
			end = end == null ? array.length - 1 : end;

			function* _qsort(_, beg, end) {
				if (beg >= end) yield undefined;

				if (end == beg + 1) {
					if ((yield fstreamline__.invoke(null, compare, [_, array[beg], array[end]], 0)) > 0) {
						var tmp = array[beg];
						array[beg] = array[end];
						array[end] = tmp;
					}
				...
				while (nbeg <= nend) {
					while (nbeg < end && (yield fstreamline__.invoke(null, compare, [_, array[nbeg], o], 0)) < 0) nbeg++;
					while (beg < nend && (yield fstreamline__.invoke(null, compare, [_, o, array[nend]], 0)) < 0) nend--;
