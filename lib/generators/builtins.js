/*** Generated by streamline 0.8.1 (generators) - DO NOT EDIT ***/var galaxy = require("streamline/lib/generators/runtime"); (galaxy.unstar(function*(_) { /**
...
(function(exports) {
	...
	exports.funnel = function(max) {
		...
		var fun = isFast ? galaxy.unstar(function*(_, fn) {
		...
		value: galaxy.unstar(function*(_, options, fn, thisObj) {
			...
			if (par === 1 || len <= 1) {
				...
				result = this.map(function(elt, i) {
					return fun(null, galaxy.unstar(function*(_) {
