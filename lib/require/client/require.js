...
(function(exports, global) {
	...
	function _load(path, callback) {
		if (_sources[path]) return callback();
	...
	function _sandbox(path, isMain) {
		if (_sandboxes[path]) return _sandboxes[path];
		...
		try {
			...
			source = "(function(require, exports, module, system, print) {var __filename='" + path + "';" + source + "\n})";
			source = source + '\n//@ sourceURL=' + path + '\n';
