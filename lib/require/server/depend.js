...
;
  ...
  return (function ___(__break) {
    var __loop = __nt(_, function __$_findModulesDir() {
      if (__3) {
    ...
    ;
      ...
      if (__2) {
        return _exists(__cb(_, function ___(__0, __1) {
...
;
  ...
  return _exists(__cb(_, function ___(__0, __1) {
    return (function __$_loadFile(__then) {
      if (__1) {
        _watch(js_);
        return require("streamline/lib/compiler/compile").loadFile(__cb(_, _), path);
      }
       else {
        return _exists(__cb(_, function ___(__0, __3) {
          return (function __$_loadFile(__then) {
            if (__3) {
              _watch(js);
              return fs.readFile(js, "utf8", __cb(_, _));
            }
             else {
              return _(new Error(("invalid require path: " + path)));
            }
          ;
          })(function __$_loadFile() {
            __then();
          });
        }), js);
      }
  ...
  return (function ___(_) {
    return (function ___(_) {
      return _exists(__cb(_, function ___(__0, __3) {
        var __2 = !__3;
        var __4 = !__2;
        return (function __$undefined(__then) {
          if (__4) {
            var __5 = __2;
            return _(null, __5);
          }
        ...
        ;
          ...
          return _exists(__cb(_, _), path);
        });
      }), (path + ".js"));
    })(__cb(_, function ___(__0, __1) {
      var __3 = !__1;
      return (function __$undefined(__then) {
        if (__3) {
          var __4 = __1;
      ...
      ;
        ...
        return fs.stat(path, __cb(_, function ___(__0, __6) {
        ...
        return _exists(__cb(_, function ___(__0, __3) {
          return (function __$_extendPath(__then) {
            if (__3) {
              ...
              return _exists(__cb(_, function ___(__0, __4) {
                return (function __$_extendPath(__then) {
                  if (__4) {
...
;
  return _findModulesDir(__cb(_, function __$_directDependencies() {
    result = [];
    dependencies[path] = result;
    return _loadFile(__cb(_, function ___(__0, __1) {
      str = __1;
...
;
  ...
  ;
    var dependencies;
    return _extendPath(__cb(_, function ___(__0, __2) {
      path = __2;
      if (knownMap[path]) {
        return _(null);
      }
    ...
    ;
      knownMap[path] = true;
      return _directDependencies(__cb(_, function ___(__0, __3) {
        dependencies = __3;
        return each(__cb(_, function __$_explore() {
          _();
        }), dependencies, function __1(_, dependency) {
          if (!_) {
            return __future(__1, arguments, 0);
          }
        ;
          return _explore(__cb(_, function __$__1() {
            _();
          }), dependency, missingMap);
        });
      }), path);
    }), path);
  };
  ...
  return each(__cb(_, function __$_missingDependencies() {
    return _explore(__cb(_, function __$_missingDependencies() {
...
;
  return funnel(__cb(_, _), function __1(_) {
    if (!_) {
      return __future(__1, arguments, 0);
    }
  ;
    return _directDependencies(__cb(_, _), path);
  });
};
...
;
  ...
  ;
    return _missingDependencies(__cb(_, _), path, known);
  });
};