  ...
  ;
    ...
    return (function ___(__break) {
      ...
      ;
        ...
        if (__2) {
          return _exists(__cb(_, __frame, 28, 1, function ___(__0, __1) {
...
;
  ...
  try {
    ...
    js = (path + ".js");
    js_ = (path + "_.js");
    return _exists(__cb(_, __frame, 81, 1, function ___(__0, __1) {
      return (function __$_loadFile(__then) {
        if (__1) {
          _watch(js_);
          return require("streamline/lib/compiler/compile").loadFile(__cb(_, __frame, 83, 1, _), path);
        }
         else {
          return _exists(__cb(_, __frame, 84, 1, function ___(__0, __3) {
            return (function __$_loadFile(__then) {
              if (__3) {
                _watch(js);
                return fs.readFile(js, "utf8", __cb(_, __frame, 86, 1, _));
              }
               else {
...
;
  ...
  try {
    return (function __$_extendPath(_) {
      return (function __$_extendPath(_) {
        return _exists(__cb(_, __frame, 92, 1, function ___(__0, __3) {
          var __2 = !__3;
          var __4 = !__2;
          ...
          ;
            ...
            return _exists(__cb(_, __frame, 92, 1, _), path);
          });
        }), (path + ".js"));
      })(__cb(_, __frame, 8, 1, function ___(__0, __1) {
        var __3 = !__1;
        return (function __$_extendPath(__then) {
          if (__3) {
            var __4 = __1;
        ...
        ;
          ...
          return fs.stat(path, __cb(_, __frame, 92, 1, function ___(__0, __6) {
            var __5 = __6.isDirectory();
            return _(null, __5);
          }));
        });
      }));
    })(__cb(_, __frame, 8, 1, function ___(__0, __2) {
      return (function __$_extendPath(__then) {
        if (__2) {
          return _exists(__cb(_, __frame, 94, 1, function ___(__0, __3) {
            return (function __$_extendPath(__then) {
              if (__3) {
                return _(null, (path + "/main"));
              }
               else {
                return _exists(__cb(_, __frame, 96, 1, function ___(__0, __4) {
                  return (function __$_extendPath(__then) {
                    if (__4) {
...
;
  ...
  ;
    return _findModulesDir(__cb(_, __frame, 107, 1, function __$_directDependencies() {
      result = [];
      dependencies[path] = result;
      return _loadFile(__cb(_, __frame, 110, 1, function ___(__0, __1) {
        str = __1;
...
;
  ...
  try {
    ...
    ;
      ...
      try {
        var dependencies;
        return _extendPath(__cb(_, __frame, 127, 1, function ___(__0, __2) {
          path = __2;
          if (knownMap[path]) {
            return _(null);
          }
        ...
        ;
          knownMap[path] = true;
          return _directDependencies(__cb(_, __frame, 133, 1, function ___(__0, __3) {
            dependencies = __3;
            return each(__cb(_, __frame, 134, 1, _), dependencies, function __1(_, dependency) {
              if (!_) {
            ...
            ;
              ...
              try {
                return _explore(__cb(_, __frame, 135, 1, _), dependency, missingMap);
              } catch (e) {
                e.__frame = (e.__frame || __frame.prev);
                __global.__frame = __frame;
                return __propagate(_, e);
    ...
    return each(__cb(_, __frame, 141, 1, function __$_missingDependencies() {
      return _explore(__cb(_, __frame, 145, 1, function __$_missingDependencies() {
    ...
    ;
      ...
      try {
        return _explore(__cb(_, __frame, 142, 1, _), cur, null);
      } catch (e) {
        e.__frame = (e.__frame || __frame.prev);
        __global.__frame = __frame;
        return __propagate(_, e);
...
;
  ...
  try {
    return funnel(__cb(_, __frame, 150, 1, _), function __1(_) {
      if (!_) {
        return __future(__1, arguments, 0);
      }
    ;
      ...
      try {
        return _directDependencies(__cb(_, __frame, 151, 1, _), path);
      } catch (e) {
        e.__frame = (e.__frame || __frame.prev);
        __global.__frame = __frame;
        return __propagate(_, e);
...
;
  ...
  try {
    return funnel(__cb(_, __frame, 155, 1, _), function __1(_) {
      if (!_) {
        return __future(__1, arguments, 0);
      }
    ;
      ...
      try {
        return _missingDependencies(__cb(_, __frame, 156, 1, _), path, known);
      } catch (e) {
        e.__frame = (e.__frame || __frame.prev);
        __global.__frame = __frame;
        return __propagate(_, e);
