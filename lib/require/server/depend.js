...
;
  var __frame = new __Frame(24, "_findModulesDir");
  try {
    var dir;
    if (modulesDir) {
  ...
  ;
    ...
    return (function ___(__break) {
      ...
      ;
        ...
        if (__2) {
          return _exists(__cb(_, __frame, 4, 6, function ___(__0, __1) {
...
;
  var __frame = new __Frame(78, "_loadFile");
  try {
    var js, js_;
    js = (path + ".js");
    js_ = (path + "_.js");
    return _exists(__cb(_, __frame, 3, 5, function ___(__0, __1) {
      return (function __$_loadFile(__then) {
        if (__1) {
          _watch(js_);
          return require("streamline/lib/compiler/compile").loadFile(__cb(_, __frame, 5, 9, _), path);
        }
         else {
          return _exists(__cb(_, __frame, 6, 12, function ___(__0, __3) {
            return (function __$_loadFile(__then) {
              if (__3) {
                _watch(js);
                return fs.readFile(js, "utf8", __cb(_, __frame, 8, 9, _));
              }
               else {
...
;
  var __frame = new __Frame(91, "_extendPath");
  try {
    return (function __$_extendPath(_) {
      return (function __$_extendPath(_) {
        return _exists(__cb(_, __frame, 1, 6, function ___(__0, __3) {
          var __2 = !__3;
          var __4 = !__2;
          ...
          ;
            ...
            return _exists(__cb(_, __frame, 1, 34, _), path);
          });
        }), (path + ".js"));
      })(__cb(_, __frame, -83, 12, function ___(__0, __1) {
        var __3 = !__1;
        return (function __$_extendPath(__then) {
          if (__3) {
            var __4 = __1;
        ...
        ;
          ...
          return fs.stat(path, __cb(_, __frame, 1, 54, function ___(__0, __6) {
            var __5 = __6.isDirectory();
            return _(null, __5);
          }));
        });
      }));
    })(__cb(_, __frame, -83, 12, function ___(__0, __2) {
      return (function __$_extendPath(__then) {
        if (__2) {
          return _exists(__cb(_, __frame, 3, 6, function ___(__0, __3) {
            return (function __$_extendPath(__then) {
              if (__3) {
                return _(null, (path + "/main"));
              }
               else {
                return _exists(__cb(_, __frame, 5, 11, function ___(__0, __4) {
                  return (function __$_extendPath(__then) {
                    if (__4) {
...
;
  var __frame = new __Frame(104, "_directDependencies");
  try {
  ...
  ;
    return _findModulesDir(__cb(_, __frame, 3, 1, function __$_directDependencies() {
      ...
      return _loadFile(__cb(_, __frame, 6, 11, function ___(__0, __1) {
        str = __1;
...
;
  var __frame = new __Frame(121, "_missingDependencies");
  ...
  ;
    var __frame = new __Frame(126, "_explore");
    try {
      var dependencies;
      return _extendPath(__cb(_, __frame, 1, 9, function ___(__0, __2) {
        path = __2;
        if (knownMap[path]) {
          return _(null);
        }
      ...
      ;
        knownMap[path] = true;
        return _directDependencies(__cb(_, __frame, 7, 21, function ___(__0, __3) {
          dependencies = __3;
          return each(__cb(_, __frame, 8, 2, _), dependencies, function __1(_, dependency) {
            if (!_) {
              return __future(__1, arguments, 0);
            }
          ;
            var __frame = new __Frame(134, "__1");
            try {
              return _explore(__cb(_, __frame, 1, 3, _), dependency, missingMap);
            } catch (e) {
              __frame.err(_, e);
            };
          });
  ...
  try {
    ...
    ;
      var __frame = new __Frame(141, "__1");
      try {
        return _explore(__cb(_, __frame, 1, 2, _), cur, null);
      } catch (e) {
        __frame.err(_, e);
      };
    });
...
exports.directDependencies = function exports_directDependencies__1(_, path) {
  if (!_) {
    return __future(exports_directDependencies__1, arguments, 0);
  }
;
  var __frame = new __Frame(149, "exports_directDependencies__1");
  try {
    return funnel(__cb(_, __frame, 1, 8, _), function __1(_) {
      if (!_) {
        return __future(__1, arguments, 0);
      }
    ;
      var __frame = new __Frame(150, "__1");
      try {
...
exports.missingDependencies = function exports_missingDependencies__2(_, path, known) {
  if (!_) {
    return __future(exports_missingDependencies__2, arguments, 0);
  }
;
  var __frame = new __Frame(154, "exports_missingDependencies__2");
  try {
    return funnel(__cb(_, __frame, 1, 8, _), function __1(_) {
      if (!_) {
        return __future(__1, arguments, 0);
    ...
    ;
      var __frame = new __Frame(155, "__1");
      try {
