...
function _loadFile(_, path) { var js, js_; var __frame = { name: "_loadFile", line: 78 }; return __func(_, this, arguments, _loadFile, 0, __frame, function __$_loadFile() {
 ...
 _watch(js_);
 return require("streamline/lib/compiler/compile").loadFile(_, path); } else {
 return _exists(__cb(_, __frame, 6, 12, function ___(__0, __3) { return (function __$_loadFile(__then) { if (__3) {
 _watch(js);
 return fs.readFile(js, "utf8", _); } else {
...
function _extendPath(_, path) { var __frame = { name: "_extendPath", line: 91 }; return __func(_, this, arguments, _extendPath, 0, __frame, function __$_extendPath() { return (function __$_extendPath(_) { return (function __$_extendPath(_) {
 return _exists(__cb(_, __frame, 1, 6, function ___(__0, __3) { var __2 = !__3; var __4 = !__2; return (function __$_extendPath(__then) { if (__4) { var __5 = __2; return _(null, __5); } else { __then(); } ; })(function __$_extendPath() { return _exists(_, path); }); }), (path + ".js")); })(__cb(_, __frame, -83, 12, function ___(__0, __1) { var __3 = !__1; return (function __$_extendPath(__then) { if (__3) { var __4 = __1; return _(null, __4); } else { __then(); } ; })(function __$_extendPath() { return fs.stat(path, __cb(_, __frame, 1, 54, function ___(__0, __6) { var __5 = __6.isDirectory(); return _(null, __5); })); }); })); })(__cb(_, __frame, -83, 12, function ___(__0, __2) { return (function __$_extendPath(__then) { if (__2) {
...
function _missingDependencies(_, path, known) { var knownMap, missingMap;
 ...
 return each(_, dependencies, function __1(_, dependency) { var __frame = { name: "__1", line: 134 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
 return _explore(_, dependency, missingMap); }); }); }), path); }), path); }); }; var __frame = { name: "_missingDependencies", line: 121 }; return __func(_, this, arguments, _missingDependencies, 0, __frame, function __$_missingDependencies() { knownMap = { }; known.forEach(function(key) { knownMap[key] = true; });
 ...
 return _(null, Object.keys(missingMap)); }), path, missingMap); }), known, function __1(_, cur) { var __frame = { name: "__1", line: 141 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return _explore(_, cur, null); }); }); });};
...
exports.directDependencies = function exports_directDependencies__1(_, path) { var __frame = { name: "exports_directDependencies__1", line: 149 }; return __func(_, this, arguments, exports_directDependencies__1, 0, __frame, function __$exports_directDependencies__1() {
 return funnel(_, function __1(_) { var __frame = { name: "__1", line: 150 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
...
exports.missingDependencies = function exports_missingDependencies__2(_, path, known) { var __frame = { name: "exports_missingDependencies__2", line: 154 }; return __func(_, this, arguments, exports_missingDependencies__2, 0, __frame, function __$exports_missingDependencies__2() {
 return funnel(_, function __1(_) { var __frame = { name: "__1", line: 155 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
