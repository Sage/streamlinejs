    ...
    return (function ___(__then) {
      (function ___(_) {
        ...
        ;
          ...
          return fs.stat((path + ".js"), __cb(_, function ___(__0, __2) {
            stats = __2;
            if (!stats.isFile()) {
              return _(null, _replyError(response, 404, ("file not found " + path)));
            }
          ;
            return depend.missingDependencies(__cb(_, function ___(__0, __3) {
              missing = __3;
              ...
              return (function __$__1(__then) {
                if ((accept.indexOf("text/html") == 0)) {
                  ...
                  return response.write(__cb(_, function __$__1() {
                    response.end();
                    return _(null);
              ...
              ;
                ...
                i = 0;
                return each(__cb(_, function __$__1() {
                  ...
                  return (function ___(__then) {
                    (function ___(_) {
                      __tryCatch(_, function __$__1() {
                        ...
                        return fs.readFile((dep + ".js"), "utf8", __cb(_, function ___(__0, __1) {
                          data = __1;
                          return response.write(__cb(_, function __$__1() {
                            __then();
