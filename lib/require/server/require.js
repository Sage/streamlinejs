...
exports.dispatcher = function(config) {
  ...
  ;
    var __frame = new __Frame(39, "__1");
    try {
      ...
      return (function ___(__then) {
        (function ___(_) {
          ...
          ;
            ...
            return fs.stat((path + ".js"), __cb(_, __frame, 15, 15, function ___(__0, __2) {
              stats = __2;
              if (!stats.isFile()) {
                return _(null, _replyError(response, 404, ("file not found " + path)));
              }
            ;
              return depend.missingDependencies(__cb(_, __frame, 19, 17, function ___(__0, __3) {
                missing = __3;
                ...
                ;
                  ...
                  ;
                    var __frame = new __Frame(85, "__1");
                    try {
                      ...
                      return (function ___(__then) {
                        (function ___(_) {
                          __tryCatch(_, function __$__1() {
                            ...
                            return fs.readFile((dep + ".js"), "utf8", __cb(_, __frame, 4, 16, function ___(__0, __1) {
                              data = __1;
                              return response.write(__cb(_, __frame, 5, 5, __then), (((((((((((("\n--" + boundary) + "\n") + "Content-ID: FILE ") + ++i) + "\n") + "Content-Location: ") + location) + "\n") + "Content-Type: application/javascript\n") + "\n") + data) + "\n"));
                            }));
                          });
                        })(function ___(ex, __result) {
                          __tryCatch(_, function __$__1() {
                            if (ex) {
                              return response.write(__cb(_, __frame, 11, 5, function __$__1() {
                                response.end(endMarker);
                                __then();
                              }), ((((((("\n--" + boundary) + "\n") + "Content-ID: ERROR\n") + "Content-Type: text/plain\n") + "\n") + ex.toString()) + "\n"));
                            }
