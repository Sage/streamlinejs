      ...
      (function(_) {
        ...
        ;
          path = (function(_) {
            var __4 = (path[0] == "/");
            if (__4) {
              return _(null, (root + path));
            }
          ;
            return _(null, ((root + "/node_modules/") + path));
          })(_);
          return fs.stat((path + ".js"), __cb(_, function(__0, __5) {
            stats = __5;
            if (!stats.isFile()) {
              return _(null, _replyError(response, 404, ("file not found " + path)));
            }
          ;
            return depend.missingDependencies(__cb(_, function(__0, __6) {
              missing = __6;
                    ...
                    (function(_) {
                      __tryCatch(_, function() {
                        ...
                        location = (function(_) {
                          var __1 = (modIndex >= 0);
                          if (__1) {
                            return _(null, dep.substring((modIndex + 14)));
                          }
                        ;
                          return _(null, dep.substring(root.length));
                        })(_);
                        return fs.readFile((dep + ".js"), "utf8", __cb(_, function(__0, __2) {
                          data = __2;
