      ...
      return (function ___(__then) {
        (function ___(_) {
          ...
          ;
            ...
            return fs.stat((path + ".js"), __cb(_, __frame, 15, 1, function ___(__0, __2) {
              stats = __2;
              if (!stats.isFile()) {
                return _(null, _replyError(response, 404, ("file not found " + path)));
              }
            ;
              return depend.missingDependencies(__cb(_, __frame, 19, 1, function ___(__0, __3) {
                missing = __3;
                ...
                return (function __$__1(__then) {
                  if ((accept.indexOf("text/html") == 0)) {
                    ...
                    return response.write(__cb(_, __frame, 26, 1, function __$__1() {
                      response.end();
                      return _(null);
                ...
                ;
                  ...
                  i = 0;
                  return each(__cb(_, __frame, 46, 1, function __$__1() {
                      ...
                      return (function ___(__then) {
                        (function ___(_) {
                          __tryCatch(_, function __$__1() {
                            ...
                            return fs.readFile((dep + ".js"), "utf8", __cb(_, __frame, 4, 1, function ___(__0, __1) {
                              data = __1;
                              return response.write(__cb(_, __frame, 5, 1, __then), (((((((((((("\n--" + boundary) + "\n") + "Content-ID: FILE ") + ++i) + "\n") + "Content-Location: ") + location) + "\n") + "Content-Type: application/javascript\n") + "\n") + data) + "\n"));
                            }));
                          });
                        })(function ___(ex, __result) {
                          __tryCatch(_, function __$__1() {
                            if (ex) {
                              return response.write(__cb(_, __frame, 11, 1, function __$__1() {
                                response.end(endMarker);
                                __then();
                              }), ((((((("\n--" + boundary) + "\n") + "Content-ID: ERROR\n") + "Content-Type: text/plain\n") + "\n") + ex.toString()) + "\n"));
                            }
