...
(function(exports) {
	...
	exports.nextTick =  (function(fstreamline_F__) {  function F(_) {   return fstreamline_F__.apply(this, arguments);  };  F.fstreamlineFunction = fstreamline_F__.fstreamlineFunction;  return F;})(fstreamline__.create(function(_) {
		fstreamline__.invoke(null, nextTick, [_], 0);
	}, 0));

	exports.collect = (function(fstreamline_F__) {  function F(_, futures) {   return fstreamline_F__.apply(this, arguments);  };  F.fstreamlineFunction = fstreamline_F__.fstreamlineFunction;  return F;})(fstreamline__.create(function(_, futures) {
		return futures && fstreamline__.invoke(futures, "map_", [_, (function(fstreamline_F__) {  function F(_, future) {   return fstreamline_F__.apply(this, arguments);  };  F.fstreamlineFunction = fstreamline_F__.fstreamlineFunction;  return F;})(fstreamline__.create(function(_, future) {
