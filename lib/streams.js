...
exports.httpServer = function __1(requestListener, options) {
  options = _fixHttpServerOptions(options);
  return options.module.createServer(function __1(request, response) {
...
HttpClientResponse.prototype.checkStatus = function __2(statuses) {
...
exports.httpRequest = function __3(options) {
...
exports.tcpClient = function __4(port, host, options) {
  host = (host || "localhost");
  options = (options || {
  });
  return new NetClient(options, port, host);
};
exports.socketClient = function __5(path, options) {
  options = (options || {
  });
