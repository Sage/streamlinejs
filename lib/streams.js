...
function WritableStream(stream, options) {
  ...
  this.__defineGetter__("stream", function __5() {
    return stream;
  });
...
exports.httpServerRequest = function __1(req, options) {
...
exports.httpServer = function __2(requestListener, options) {
...
HttpClientResponse.prototype.checkStatus = function __3(statuses) {
...
exports.httpRequest = function __4(options) {
...
exports.tcpClient = function __5(port, host, options) {
  host = (host || "localhost");
  options = (options || {
  });
  return new NetClient(options, port, host);
};
exports.socketClient = function __6(path, options) {
  options = (options || {
  });
