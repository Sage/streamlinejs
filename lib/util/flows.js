...
(function __1(exports) {
  ...
  ;
    ...
    return function(__break) {
      ...
      ;
        if ((i < len)) {
          return fn.call(thisObj, __cb(_, __then), array[i], i);
        }
         else {
          return __break();
        }
  ...
  exports.spray = function __9(fns, max) {
  ...
  exports.funnel = function __10(max) {
  ...
  exports.collect = function __11(_, futures) {
    if (!_) {
      return __future(__11, arguments, 0);
    }
  ;
    var __then = _;
  ...
  exports.setContext = function __12(ctx) {
    var old = __global.__context;
    __global.__context = ctx;
    return old;
  };
  exports.getContext = function __13() {
    return __global.__context;
  };
  exports.nextTick = (((typeof process === "object") && (typeof process.nextTick === "function")) ? process.nextTick : function __14(callback) {
