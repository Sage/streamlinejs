/*** Generated by streamline 0.1.46 - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime')(__filename),__g=__rt.__g,__func=__rt.__func,__cb=__rt.__cb,__forIn=__rt.__forIn,__future=__rt.__future,__propagate=__rt.__propagate,__trap=__rt.__trap,__setEF=__rt.__setEF; if ((typeof fstreamline__ !== "undefined")) {
...
(function(exports) {
 ...
 exports.each = function exports_each__1(_, array, fn, thisObj) { var len, i; var __frame = { name: "exports_each__1", line: 47 }; return __func(_, this, arguments, exports_each__1, 0, __frame, function __$exports_each__1() {
 ...
 exports.map = function exports_map__2(_, array, fn, thisObj) { var result, len, i; var __frame = { name: "exports_map__2", line: 58 }; return __func(_, this, arguments, exports_map__2, 0, __frame, function __$exports_map__2() {
 if (!array) {
 return _(null, array); } ;
 result = [];
 len = array.length;
 ...
 exports.filter = function exports_filter__3(_, array, fn, thisObj) { var result, len, i, elt; var __frame = { name: "exports_filter__3", line: 70 }; return __func(_, this, arguments, exports_filter__3, 0, __frame, function __$exports_filter__3() {
 if (!array) {
 return _(null, array); } ;
 result = [];
 len = array.length;
 ...
 exports.every = function exports_every__4(_, array, fn, thisObj) { var len, i; var __frame = { name: "exports_every__4", line: 85 }; return __func(_, this, arguments, exports_every__4, 0, __frame, function __$exports_every__4() {
 ...
 exports.some = function exports_some__5(_, array, fn, thisObj) { var len, i; var __frame = { name: "exports_some__5", line: 98 }; return __func(_, this, arguments, exports_some__5, 0, __frame, function __$exports_some__5() {
 if (!array) { return _(null); } ;
 ...
 exports.reduce = function exports_reduce__6(_, array, fn, v, thisObj) { var len, i; var __frame = { name: "exports_reduce__6", line: 111 }; return __func(_, this, arguments, exports_reduce__6, 0, __frame, function __$exports_reduce__6() {
 if (!array) {
 return _(null, v); } ;
 len = array.length;
 ...
 exports.reduceRight = function exports_reduceRight__7(_, array, fn, v, thisObj) { var len, i; var __frame = { name: "exports_reduceRight__7", line: 123 }; return __func(_, this, arguments, exports_reduceRight__7, 0, __frame, function __$exports_reduceRight__7() {
 if (!array) {
 return _(null, v); } ;
 len = array.length;
 ...
 function _qsort(_, beg, end) { var tmp, mid, o, nbeg, nend; var __frame = { name: "_qsort", line: 142 }; return __func(_, this, arguments, _qsort, 0, __frame, function __$_qsort() {
 ...
 var __1 = (nbeg < end); if (!__1) { return _(null, __1); } ; return compare(__cb(_, __frame, 19, 25, function ___(__0, __3) { var __2 = (__3 < 0); return _(null, __2); }), array[nbeg], o); })(__cb(_, __frame, -141, 17, _)); })(__cb(_, __frame, -141, 17, function ___(__0, __5) { if (__5) {
 ...
 var __1 = (beg < nend); if (!__1) { return _(null, __1); } ; return compare(__cb(_, __frame, 22, 25, function ___(__0, __3) { var __2 = (__3 < 0); return _(null, __2); }), o, array[nend]); })(__cb(_, __frame, -141, 17, _)); })(__cb(_, __frame, -141, 17, function ___(__0, __7) { if (__7) {
 ...
 if ((beg < nend)) {
 return _qsort(__cb(_, __frame, 37, 4, __then), beg, nend); } else { __then(); } ; })(_); }); }); }); }); }; var __frame = { name: "exports_sort__8", line: 138 }; return __func(_, this, arguments, exports_sort__8, 0, __frame, function __$exports_sort__8() { beg = (beg || 0); end = ((end == null) ? (array.length - 1) : end);
 ...
 exports.eachKey = function exports_eachKey__9(_, obj, fn, thisObj) { var key; var __frame = { name: "exports_eachKey__9", line: 191 }; return __func(_, this, arguments, exports_eachKey__9, 0, __frame, function __$exports_eachKey__9() {
 if (!obj) {
 return _(null, obj); } ;
 ...
 exports.collect = function exports_collect__10(_, futures) { var __frame = { name: "exports_collect__10", line: 292 }; return __func(_, this, arguments, exports_collect__10, 0, __frame, function __$exports_collect__10() {
 return exports.map(__cb(_, __frame, 1, 9, _), futures, function __1(_, future) { var __frame = { name: "__1", line: 293 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
