...
(function(exports) {
  ...
  ;
    ...
    return (function ___(__break) {
      var __loop = __nt(_, function __$Object$each() {
        if (__2) {
          i++;
        }
         else {
      ...
      ;
        var __1 = (i < len);
        if (__1) {
          return fn.call(thisObj, __cb(_, function __$Object$each() {
            __loop();
          }), array[i], i);
        }
         else {
  ...
  ;
    ...
    var __3 = false;
    return (function ___(__break) {
      var __loop = __nt(_, function __$Object$map() {
        if (__3) {
          i++;
        }
         else {
  ...
  ;
    ...
    var __3 = false;
    return (function ___(__break) {
      var __loop = __nt(_, function __$Object$filter() {
        if (__3) {
          i++;
        }
         else {
  ...
  ;
    ...
    var __4 = false;
    return (function ___(__break) {
      var __loop = __nt(_, function __$Object$every() {
        if (__4) {
          i++;
        }
         else {
  ...
  ;
    ...
    var __3 = false;
    return (function ___(__break) {
      var __loop = __nt(_, function __$Object$some() {
        if (__3) {
          i++;
        }
         else {
  ...
  ;
    ...
    var __3 = false;
    return (function ___(__break) {
      var __loop = __nt(_, function __$Object$reduce() {
        if (__3) {
          i++;
        }
         else {
  ...
  ;
    ...
    var __3 = false;
    return (function ___(__break) {
      var __loop = __nt(_, function __$Object$reduceRight() {
        if (__3) {
          i--;
        }
         else {
  ...
  ;
    ...
    var __2 = 0;
    return (function ___(__break) {
      var __loop = __nt(_, function __$Object$eachKey() {
        var __3 = (__2 < __1.length);
        if (__3) {
          key = __1[__2++];
          return (function __$Object$eachKey(__then) {
            if (Object.prototype.hasOwnProperty.call(obj, key)) {
              return fn.call(thisObj, __cb(_, function __$Object$eachKey() {
                __then();
              }), key, obj[key]);
            }
             else {
