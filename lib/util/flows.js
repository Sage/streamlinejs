...
(function(exports) {
    ...
    ;
      ...
      return (function ___(__break) {
        ...
        ;
          var __1 = (i < len);
          if (__1) {
            return fn.call(thisObj, __cb(_, __frame, 49, 1, __loop), array[i], i);
          }
           else {
            __break();
          }
    ...
    ;
      ...
      return (function ___(__break) {
        ...
        ;
          var __2 = (i < len);
          if (__2) {
            return fn.call(thisObj, __cb(_, __frame, 61, 1, function ___(__0, __1) {
              result[i] = __1;
              __loop();
            }), array[i], i);
          }
    ...
    ;
      ...
      return (function ___(__break) {
        ...
        ;
          ...
          if (__2) {
            elt = array[i];
            return fn.call(thisObj, __cb(_, __frame, 74, 1, function ___(__0, __1) {
    ...
    ;
      ...
      return (function ___(__break) {
        ...
        ;
          var __3 = (i < len);
          if (__3) {
            return fn.call(thisObj, __cb(_, __frame, 87, 1, function ___(__0, __2) {
              var __1 = !__2;
    ...
    ;
      ...
      return (function ___(__break) {
        ...
        ;
          var __2 = (i < len);
          if (__2) {
            return fn.call(thisObj, __cb(_, __frame, 100, 1, function ___(__0, __1) {
    ...
    ;
      ...
      return (function ___(__break) {
        ...
        ;
          var __2 = (i < len);
          if (__2) {
            return fn.call(thisObj, __cb(_, __frame, 113, 1, function ___(__0, __1) {
              v = __1;
              __loop();
            }), v, array[i], i, array);
          }
    ...
    ;
      ...
      return (function ___(__break) {
        ...
        ;
          var __2 = (i >= 0);
          if (__2) {
            return fn.call(thisObj, __cb(_, __frame, 125, 1, function ___(__0, __1) {
              v = __1;
              __loop();
            }), v, array[i], i, array);
          }
          ...
          if (__3) {
            ...
            return (function __$Object$eachKey(__then) {
              if (Object.prototype.hasOwnProperty.call(obj, key)) {
                return fn.call(thisObj, __cb(_, __frame, 141, 1, __then), key, obj[key]);
              }
               else {
                __then();
              }
  ...
  ;
    ...
    try {
      return exports.map(__cb(_, __frame, 238, 1, _), futures, function __1(_, future) {
        if (!_) {
      ...
      ;
        ...
        try {
          return future(__cb(_, __frame, 239, 1, _));
        } catch (e) {
          e.__frame = (e.__frame || __frame.prev);
          __global.__frame = __frame;
          return __propagate(_, e);
