...
(function(exports) {
  "use strict";
  exports.each = function exports_each__1(_, array, fn, thisObj) {
    if (!_) {
      return __future(exports_each__1, arguments, 0);
    }
  ;
    var __frame = new __Frame(44, "exports_each__1");
    try {
      var len, i;
    ...
    ;
      ...
      return (function ___(__break) {
        var __loop = __nt(_, __frame, function __$exports_each__1() {
          if (__2) {
            i++;
          }
           else {
  ...
  exports.map = function exports_map__2(_, array, fn, thisObj) {
    if (!_) {
      return __future(exports_map__2, arguments, 0);
    }
  ;
    var __frame = new __Frame(55, "exports_map__2");
    try {
      var result, len, i;
      if (!array) {
        return _(null, array);
    ...
    ;
      ...
      var __3 = false;
      return (function ___(__break) {
        var __loop = __nt(_, __frame, function __$exports_map__2() {
          if (__3) {
            i++;
          }
           else {
  ...
  exports.filter = function exports_filter__3(_, array, fn, thisObj) {
    if (!_) {
      return __future(exports_filter__3, arguments, 0);
    }
  ;
    var __frame = new __Frame(67, "exports_filter__3");
    try {
    ...
    ;
      ...
      var __3 = false;
      return (function ___(__break) {
        var __loop = __nt(_, __frame, function __$exports_filter__3() {
          if (__3) {
            i++;
          }
           else {
        ...
        ;
          ...
          if (__2) {
            ...
            return fn.call(thisObj, __cb(_, __frame, 7, 7, function ___(__0, __1) {
              return (function __$exports_filter__3(__then) {
                if (__1) {
                  result.push(elt);
                  __then();
                }
  ...
  exports.every = function exports_every__4(_, array, fn, thisObj) {
    if (!_) {
      return __future(exports_every__4, arguments, 0);
    }
  ;
    var __frame = new __Frame(82, "exports_every__4");
    try {
      var len, i;
      if (!array) {
        return _(null);
    ...
    ;
      ...
      var __4 = false;
      return (function ___(__break) {
        var __loop = __nt(_, __frame, function __$exports_every__4() {
          if (__4) {
            i++;
          }
           else {
        ...
        ;
          ...
          if (__3) {
            return fn.call(thisObj, __cb(_, __frame, 5, 8, function ___(__0, __2) {
              var __1 = !__2;
              return (function __$exports_every__4(__then) {
                if (__1) {
                  return _(null, false);
                }
                 else {
  ...
  exports.some = function exports_some__5(_, array, fn, thisObj) {
    if (!_) {
      return __future(exports_some__5, arguments, 0);
    }
  ;
    var __frame = new __Frame(95, "exports_some__5");
    try {
      var len, i;
      if (!array) {
        return _(null);
    ...
    ;
      ...
      var __3 = false;
      return (function ___(__break) {
        var __loop = __nt(_, __frame, function __$exports_some__5() {
          if (__3) {
            i++;
          }
           else {
        ...
        ;
          ...
          if (__2) {
            return fn.call(thisObj, __cb(_, __frame, 5, 7, function ___(__0, __1) {
              return (function __$exports_some__5(__then) {
                if (__1) {
                  return _(null, true);
                }
                 else {
  ...
  exports.reduce = function exports_reduce__6(_, array, fn, v, thisObj) {
    if (!_) {
      return __future(exports_reduce__6, arguments, 0);
    }
  ;
    var __frame = new __Frame(108, "exports_reduce__6");
    try {
      var len, i;
      if (!array) {
        return _(null, v);
    ...
    ;
      ...
      var __3 = false;
      return (function ___(__break) {
        var __loop = __nt(_, __frame, function __$exports_reduce__6() {
          if (__3) {
            i++;
          }
           else {
  ...
  exports.reduceRight = function exports_reduceRight__7(_, array, fn, v, thisObj) {
    if (!_) {
      return __future(exports_reduceRight__7, arguments, 0);
    }
  ;
    var __frame = new __Frame(120, "exports_reduceRight__7");
    try {
      var len, i;
      if (!array) {
        return _(null, v);
    ...
    ;
      ...
      var __3 = false;
      return (function ___(__break) {
        var __loop = __nt(_, __frame, function __$exports_reduceRight__7() {
          if (__3) {
            i--;
          }
           else {
        ...
        __loop();
      })(function __$exports_reduceRight__7() {
        return _(null, v);
      });
    } catch (e) {
      __frame.err(_, e);
  ...
  exports.eachKey = function exports_eachKey__8(_, obj, fn, thisObj) {
    if (!_) {
      return __future(exports_eachKey__8, arguments, 0);
    }
  ;
    var __frame = new __Frame(136, "exports_eachKey__8");
    try {
      var key;
      if (!obj) {
        return _(null, obj);
    ...
    ;
      ...
      var __2 = 0;
      return (function ___(__break) {
        var __loop = __nt(_, __frame, function __$exports_eachKey__8() {
          var __3 = (__2 < __1.length);
          if (__3) {
            key = __1[__2++];
            return (function __$exports_eachKey__8(__then) {
        ...
        __loop();
      })(function __$exports_eachKey__8() {
        return _(null, obj);
      });
    } catch (e) {
      __frame.err(_, e);
  ...
  exports.collect = function exports_collect__9(_, futures) {
    if (!_) {
      return __future(exports_collect__9, arguments, 0);
    }
  ;
    var __frame = new __Frame(237, "exports_collect__9");
    try {
