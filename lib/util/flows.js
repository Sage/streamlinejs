/*** Generated by streamline 0.1.36-stack - DO NOT EDIT ***/ var __global = typeof global !== 'undefined' ? global : window;var __srcName='node_modules/streamline/lib/util/flows_.js'; function __func(_, __this, __arguments, fn, index, frame, body) { if (!_) { return __future.call(__this, fn, __arguments, index); } frame.file = __srcName; frame.prev = __global.__frame; __global.__frame = frame; try { body(); } catch (e) { e.__frame = e.__frame || frame.prev; __propagate(_, e); } finally { __global.__frame = __frame.prev; } } function __cb(_, frame, offset, col, fn){ var ctx = __global.__context; frame.offset = offset; frame.col = col; return function ___(err, result){ var oldFrame = __global.__frame; __global.__frame = frame; __global.__context = ctx; try { if (err) { err.__frame = err.__frame || frame; return _(err); } return fn(null, result); } catch (ex) { ex.__frame = ex.__frame || frame; return __propagate(_, ex); } finally { __global.__frame = oldFrame; } } } function __future(fn, args, i){ var done, err, result; var cb = function(e, r){ done = true; err = e, result = r; }; args = Array.prototype.slice.call(args); args[i] = function ___(e, r){ cb(e, r); }; fn.apply(this, args); return function ___(_){ if (done) _.call(this, err, result); else cb = _.bind(this); } .bind(this); } function __nt(_, frame, fn){ var i = 0; var cb = __cb(_, frame, 0, 0, fn); var safeCb = function ___(){ try { cb(); } catch (ex) { __propagate(cb, ex); } }; if (typeof process != "undefined" && typeof process.nextTick == "function") return function ___(){ if (++i % 20 == 0) process.nextTick(safeCb); else cb(); }; else return function ___(){ if (++i % 20 == 0) setTimeout(safeCb); else cb(); }; } function __propagate(_, err){ try { _(err); } catch (ex) { __trap(ex); } } function __trap(err){ if (err) { if (__global.__context && __global.__context.errorHandler) __global.__context.errorHandler(err); else console.error("UNCAUGHT EXCEPTION: " + err.message + "\n" + err.stack); } } function __forIn(object){ var array = []; for (var obj in object) { array.push(obj); } return array; } (function(exports) {
 ...
 exports.each = function exports_each__1(_, array, fn, thisObj) { var len, i; var __frame = { name: "exports_each__1", line: 44 }; __func(_, this, arguments, exports_each__1, 0, __frame, function __$exports_each__1() {
 ...
 exports.map = function exports_map__2(_, array, fn, thisObj) { var result, len, i; var __frame = { name: "exports_map__2", line: 55 }; __func(_, this, arguments, exports_map__2, 0, __frame, function __$exports_map__2() {
 if (!array) {
 return _(null, array); } ;
 result = [];
 len = array.length;
 ...
 exports.filter = function exports_filter__3(_, array, fn, thisObj) { var result, len, i, elt; var __frame = { name: "exports_filter__3", line: 67 }; __func(_, this, arguments, exports_filter__3, 0, __frame, function __$exports_filter__3() {
 if (!array) {
 return _(null, array); } ;
 result = [];
 len = array.length;
 ...
 exports.every = function exports_every__4(_, array, fn, thisObj) { var len, i; var __frame = { name: "exports_every__4", line: 82 }; __func(_, this, arguments, exports_every__4, 0, __frame, function __$exports_every__4() {
 ...
 exports.some = function exports_some__5(_, array, fn, thisObj) { var len, i; var __frame = { name: "exports_some__5", line: 95 }; __func(_, this, arguments, exports_some__5, 0, __frame, function __$exports_some__5() {
 if (!array) { return _(null); } ;
 ...
 exports.reduce = function exports_reduce__6(_, array, fn, v, thisObj) { var len, i; var __frame = { name: "exports_reduce__6", line: 108 }; __func(_, this, arguments, exports_reduce__6, 0, __frame, function __$exports_reduce__6() {
 if (!array) {
 return _(null, v); } ;
 len = array.length;
 ...
 exports.reduceRight = function exports_reduceRight__7(_, array, fn, v, thisObj) { var len, i; var __frame = { name: "exports_reduceRight__7", line: 120 }; __func(_, this, arguments, exports_reduceRight__7, 0, __frame, function __$exports_reduceRight__7() {
 if (!array) {
 return _(null, v); } ;
 len = array.length;
 ...
 exports.eachKey = function exports_eachKey__8(_, obj, fn, thisObj) { var key; var __frame = { name: "exports_eachKey__8", line: 136 }; __func(_, this, arguments, exports_eachKey__8, 0, __frame, function __$exports_eachKey__8() {
 if (!obj) {
 return _(null, obj); } ;
 ...
 exports.collect = function exports_collect__9(_, futures) { var __frame = { name: "exports_collect__9", line: 237 }; __func(_, this, arguments, exports_collect__9, 0, __frame, function __$exports_collect__9() {
 return exports.map(__cb(_, __frame, 1, 9, _), futures, function __1(_, future) { var __frame = { name: "__1", line: 238 }; __func(_, this, arguments, __1, 0, __frame, function __$__1() {
