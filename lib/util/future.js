	...
	exports.future = function(fn, args, i) {
		...
		return function F(cb) {
			if (typeof cb !== 'function') {
				if (cb !== false && !require('streamline/globals').oldStyleFutures) throw new Error("invalid argument #0: you must pass _ or !_ (see https://github.com/Sage/streamlinejs/issues/164)");
				return F;
			}
